...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/grafana/pyroscope/api/gen/proto/go/copmactor/v1"
	http "net/http"
	strings "strings"
)
...
var (
	compactionPlannerServiceDescriptor                 = v1.File_copmactor_v1_compactor_proto.Services().ByName("CompactionPlanner")
