...
func (m *AdHocProfilesUploadRequest) CloneVT() *AdHocProfilesUploadRequest {
	...
	r := new(AdHocProfilesUploadRequest)
	r.Name = m.Name
	r.Profile = m.Profile
...
func (m *AdHocProfilesGetResponse) CloneVT() *AdHocProfilesGetResponse {
	...
	r := new(AdHocProfilesGetResponse)
	r.Id = m.Id
	r.Name = m.Name
	r.UploadedAt = m.UploadedAt
...
func (m *AdHocProfilesListRequest) CloneVT() *AdHocProfilesListRequest {
	...
	r := new(AdHocProfilesListRequest)
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *AdHocProfilesListResponse) CloneVT() *AdHocProfilesListResponse {
	...
	r := new(AdHocProfilesListResponse)
...
func (m *AdHocProfilesProfileMetadata) CloneVT() *AdHocProfilesProfileMetadata {
	...
	r := new(AdHocProfilesProfileMetadata)
	r.Id = m.Id
	r.Name = m.Name
	r.UploadedAt = m.UploadedAt
	if len(m.unknownFields) > 0 {
...
func (m *AdHocProfilesGetResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.UploadedAt != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.UploadedAt))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Name) > 0 {
...
func (m *AdHocProfilesUploadRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdHocProfilesGetRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdHocProfilesGetResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 5:
			...
			m.ProfileTypes = append(m.ProfileTypes, stringValue)
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlamebearerProfile", wireType)
			...
			m.FlamebearerProfile = stringValue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *AdHocProfilesListRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdHocProfilesListResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdHocProfilesProfileMetadata) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
