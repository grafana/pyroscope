...
func (c *agentServiceClient) GetTargets(ctx context.Context, in *GetTargetsRequest, opts ...grpc.CallOption) (*GetTargetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/agent.v1alpha1.AgentService/GetTargets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_GetTargets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/agent.v1alpha1.AgentService/GetTargets",
	}
...
func (m *Target) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ScrapeInterval != nil {
		if marshalto, ok := interface{}(m.ScrapeInterval).(interface {
	...
	if m.ScrapeTimeout != nil {
		if marshalto, ok := interface{}(m.ScrapeTimeout).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := marshalto.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
