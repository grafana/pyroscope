...
func (m *CompactionJob) CloneVT() *CompactionJob {
	...
	r.Tombstones = m.Tombstones.CloneVT()
...
func (this *CompactionJob) EqualVT(that *CompactionJob) bool {
	...
	if !this.Tombstones.EqualVT(that.Tombstones) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (m *CompactionJob) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Tombstones != nil {
		size, err := m.Tombstones.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CompactionJob) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := m.Tombstones.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
