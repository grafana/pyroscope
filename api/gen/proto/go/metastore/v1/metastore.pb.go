...
type RaftStatusCode int32

const (
	RaftStatusCode_OK         RaftStatusCode = 0
	RaftStatusCode_NOT_LEADER RaftStatusCode = 1
)

// Enum value maps for RaftStatusCode.
var (
	RaftStatusCode_name = map[int32]string{
		0: "OK",
		1: "NOT_LEADER",
	}
	RaftStatusCode_value = map[string]int32{
		"OK":         0,
		"NOT_LEADER": 1,
	}
)

func (x RaftStatusCode) Enum() *RaftStatusCode {
	p := new(RaftStatusCode)
	*p = x
	return p
}

func (x RaftStatusCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RaftStatusCode) Descriptor() protoreflect.EnumDescriptor {
	return file_metastore_v1_metastore_proto_enumTypes[0].Descriptor()
}

func (RaftStatusCode) Type() protoreflect.EnumType {
	return &file_metastore_v1_metastore_proto_enumTypes[0]
}

func (x RaftStatusCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RaftStatusCode.Descriptor instead.
func (RaftStatusCode) EnumDescriptor() ([]byte, []int) {
...
type AddBlockResponse struct {
	...
	RaftStatus *RaftStatus `protobuf:"bytes,1,opt,name=raft_status,json=raftStatus,proto3" json:"raft_status,omitempty"`
}
...
func (x *AddBlockResponse) GetRaftStatus() *RaftStatus {
	if x != nil {
		return x.RaftStatus
	}
	return nil
...
type QueryMetadataResponse struct {
	...
	RaftStatus *RaftStatus  `protobuf:"bytes,2,opt,name=raft_status,json=raftStatus,proto3" json:"raft_status,omitempty"`
}
...
func (x *QueryMetadataResponse) GetRaftStatus() *RaftStatus {
	if x != nil {
		return x.RaftStatus
	}
	return nil
...
func (x *ReadIndexResponse) GetRaftStatus() *RaftStatus {
	if x != nil {
		return x.RaftStatus
	}
	return nil
...
type RaftStatus struct {
	...
	Code   RaftStatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=metastore.v1.RaftStatusCode" json:"code,omitempty"`
...
func (x *RaftStatus) GetCode() RaftStatusCode {
	if x != nil {
		return x.Code
	}
	return RaftStatusCode_OK
}

func (x *RaftStatus) GetLeader() string {
	if x != nil {
		return x.Leader
	}
	return ""
...
var file_metastore_v1_metastore_proto_rawDesc = []byte{
	...
	,
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x14,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x08,
	0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	...
	0x69, 0x7a, 0x65, 0x22, 0xff, 0x01, 0x0a, 0x07, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x12,
	...
	0x73, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x65, 0x6e,
	...
	0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b,
	0x0a, 0x09, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x83, 0x01, 0x0a, 0x15,
	...
	,
	...
	0x64, 0x65, 0x78, 0x12, 0x39, 0x0a, 0x0b, 0x72, 0x61, 0x66, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x61, 0x66, 0x74, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x0a, 0x72, 0x61, 0x66, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x56,
	0x0a, 0x0a, 0x52, 0x61, 0x66, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x04,
	0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6d, 0x65, 0x74,
	0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x61, 0x66, 0x74, 0x53, 0x74,
	...
	0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x2a, 0x28, 0x0a, 0x0e, 0x52, 0x61, 0x66, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x06, 0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00,
	0x12, 0x0e, 0x0a, 0x0a, 0x4e, 0x4f, 0x54, 0x5f, 0x4c, 0x45, 0x41, 0x44, 0x45, 0x52, 0x10, 0x01,
	0x32, 0x8b, 0x02, 0x0a, 0x10, 0x4d, 0x65, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x65,
	...
	,
...
var file_metastore_v1_metastore_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_metastore_v1_metastore_proto_goTypes = []any{
	(RaftStatusCode)(0),           // 0: metastore.v1.RaftStatusCode
	(*AddBlockRequest)(nil),       // 1: metastore.v1.AddBlockRequest
	(*AddBlockResponse)(nil),      // 2: metastore.v1.AddBlockResponse
	(*BlockMeta)(nil),             // 3: metastore.v1.BlockMeta
	(*Dataset)(nil),               // 4: metastore.v1.Dataset
	(*QueryMetadataRequest)(nil),  // 5: metastore.v1.QueryMetadataRequest
	(*QueryMetadataResponse)(nil), // 6: metastore.v1.QueryMetadataResponse
	(*ReadIndexRequest)(nil),      // 7: metastore.v1.ReadIndexRequest
	(*ReadIndexResponse)(nil),     // 8: metastore.v1.ReadIndexResponse
	(*RaftStatus)(nil),            // 9: metastore.v1.RaftStatus
	(*v1.Labels)(nil),             // 10: types.v1.Labels
}
var file_metastore_v1_metastore_proto_depIdxs = []int32{
	3,  // 0: metastore.v1.AddBlockRequest.block:type_name -> metastore.v1.BlockMeta
	9,  // 1: metastore.v1.AddBlockResponse.raft_status:type_name -> metastore.v1.RaftStatus
	4,  // 2: metastore.v1.BlockMeta.datasets:type_name -> metastore.v1.Dataset
	10, // 3: metastore.v1.Dataset.labels:type_name -> types.v1.Labels
	3,  // 4: metastore.v1.QueryMetadataResponse.blocks:type_name -> metastore.v1.BlockMeta
	9,  // 5: metastore.v1.QueryMetadataResponse.raft_status:type_name -> metastore.v1.RaftStatus
	9,  // 6: metastore.v1.ReadIndexResponse.raft_status:type_name -> metastore.v1.RaftStatus
	0,  // 7: metastore.v1.RaftStatus.code:type_name -> metastore.v1.RaftStatusCode
	1,  // 8: metastore.v1.MetastoreService.AddBlock:input_type -> metastore.v1.AddBlockRequest
	5,  // 9: metastore.v1.MetastoreService.QueryMetadata:input_type -> metastore.v1.QueryMetadataRequest
	7,  // 10: metastore.v1.MetastoreService.ReadIndex:input_type -> metastore.v1.ReadIndexRequest
	2,  // 11: metastore.v1.MetastoreService.AddBlock:output_type -> metastore.v1.AddBlockResponse
	6,  // 12: metastore.v1.MetastoreService.QueryMetadata:output_type -> metastore.v1.QueryMetadataResponse
	8,  // 13: metastore.v1.MetastoreService.ReadIndex:output_type -> metastore.v1.ReadIndexResponse
...
func file_metastore_v1_metastore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_metastore_v1_metastore_proto_enumTypes,
