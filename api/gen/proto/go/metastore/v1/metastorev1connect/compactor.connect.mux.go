...
func RegisterCompactionPlannerHandler(mux *mux.Router, svc CompactionPlannerHandler, opts ...connect.HandlerOption) {
	mux.Handle("/metastore.v1.CompactionPlanner/PollCompactionJobs", connect.NewUnaryHandler(
		"/metastore.v1.CompactionPlanner/PollCompactionJobs",
		svc.PollCompactionJobs,
		opts...,
	))
	mux.Handle("/metastore.v1.CompactionPlanner/GetCompactionJobs", connect.NewUnaryHandler(
		"/metastore.v1.CompactionPlanner/GetCompactionJobs",
