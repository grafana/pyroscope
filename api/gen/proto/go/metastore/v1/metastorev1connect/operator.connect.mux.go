...
// RegisterOperatorServiceHandler register an HTTP handler to a mux.Router from the service
// implementation.
func RegisterOperatorServiceHandler(mux *mux.Router, svc OperatorServiceHandler, opts ...connect.HandlerOption) {
	mux.Handle("/metastore.v1.OperatorService/Info", connect.NewUnaryHandler(
		"/metastore.v1.OperatorService/Info",
		svc.Info,
		opts...,
	))
}
