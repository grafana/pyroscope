...
const (
	...
	RaftCommand_RAFT_COMMAND_REPLACE_BLOCK_METADATA     RaftCommand = 2
	RaftCommand_RAFT_COMMAND_GET_COMPACTION_PLAN_UPDATE RaftCommand = 3
	RaftCommand_RAFT_COMMAND_UPDATE_COMPACTION_PLAN     RaftCommand = 4
)
...
var (
	RaftCommand_name = map[int32]string{
		...
		2: "RAFT_COMMAND_REPLACE_BLOCK_METADATA",
		3: "RAFT_COMMAND_GET_COMPACTION_PLAN_UPDATE",
		4: "RAFT_COMMAND_UPDATE_COMPACTION_PLAN",
	}
	RaftCommand_value = map[string]int32{
		"RAFT_COMMAND_UNKNOWN":                    0,
		"RAFT_COMMAND_ADD_BLOCK_METADATA":         1,
		"RAFT_COMMAND_REPLACE_BLOCK_METADATA":     2,
		"RAFT_COMMAND_GET_COMPACTION_PLAN_UPDATE": 3,
		"RAFT_COMMAND_UPDATE_COMPACTION_PLAN":     4,
	}
)
...
type ReplaceBlockMetadataRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SourceBlocks []string        `protobuf:"bytes,3,rep,name=source_blocks,json=sourceBlocks,proto3" json:"source_blocks,omitempty"`
	NewBlocks    []*v1.BlockMeta `protobuf:"bytes,4,rep,name=new_blocks,json=newBlocks,proto3" json:"new_blocks,omitempty"`
}

func (x *ReplaceBlockMetadataRequest) Reset() {
	*x = ReplaceBlockMetadataRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplaceBlockMetadataRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplaceBlockMetadataRequest) ProtoMessage() {}

func (x *ReplaceBlockMetadataRequest) ProtoReflect() protoreflect.Message {
	mi := &file_metastore_v1_raft_log_raft_log_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplaceBlockMetadataRequest.ProtoReflect.Descriptor instead.
func (*ReplaceBlockMetadataRequest) Descriptor() ([]byte, []int) {
	return file_metastore_v1_raft_log_raft_log_proto_rawDescGZIP(), []int{2}
}

func (x *ReplaceBlockMetadataRequest) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
func (x *ReplaceBlockMetadataRequest) GetShard() uint32 {
	if x != nil {
		return x.Shard
	}
	return 0
...
func (x *ReplaceBlockMetadataRequest) GetSourceBlocks() []string {
	if x != nil {
...
func (x *ReplaceBlockMetadataRequest) GetNewBlocks() []*v1.BlockMeta {
	if x != nil {
		return x.NewBlocks
	}
	return nil
...
type ReplaceBlockMetadataResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReplaceBlockMetadataResponse) Reset() {
	*x = ReplaceBlockMetadataResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplaceBlockMetadataResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplaceBlockMetadataResponse) ProtoMessage() {}

func (x *ReplaceBlockMetadataResponse) ProtoReflect() protoreflect.Message {
	mi := &file_metastore_v1_raft_log_raft_log_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplaceBlockMetadataResponse.ProtoReflect.Descriptor instead.
func (*ReplaceBlockMetadataResponse) Descriptor() ([]byte, []int) {
...
type CompactionPlanUpdate struct {
	...
	NewJobs         []*CompactionJobPlan  `protobuf:"bytes,1,rep,name=new_jobs,json=newJobs,proto3" json:"new_jobs,omitempty"`
	ScheduleUpdates []*CompactionJobState `protobuf:"bytes,2,rep,name=schedule_updates,json=scheduleUpdates,proto3" json:"schedule_updates,omitempty"`
}
...
func (x *CompactionPlanUpdate) GetNewJobs() []*CompactionJobPlan {
	if x != nil {
		return x.NewJobs
	}
	return nil
...
func (x *CompactionPlanUpdate) GetScheduleUpdates() []*CompactionJobState {
	if x != nil {
...
func (x *CompactionJobPlan) GetCompactedBlocks() []*v1.BlockMeta {
	if x != nil {
...
func (x *CompactionJobPlan) GetDeletedBlocks() []string {
	if x != nil {
...
var file_metastore_v1_raft_log_raft_log_proto_rawDesc = []byte{
	...
	0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa8, 0x01, 0x0a, 0x1b, 0x52, 0x65, 0x70,
	0x6c, 0x61, 0x63, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x65, 0x6e, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x61, 0x66, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0xa2,
	0x02, 0x03, 0x52, 0x58, 0x58, 0xaa, 0x02, 0x07, 0x52, 0x61, 0x66, 0x74, 0x4c, 0x6f, 0x67, 0xca,
	0x02, 0x07, 0x52, 0x61, 0x66, 0x74, 0x4c, 0x6f, 0x67, 0xe2, 0x02, 0x13, 0x52, 0x61, 0x66, 0x74,
	0x4c, 0x6f, 0x67, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea,
	0x02, 0x07, 0x52, 0x61, 0x66, 0x74, 0x4c, 0x6f, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_metastore_v1_raft_log_raft_log_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_metastore_v1_raft_log_raft_log_proto_goTypes = []any{
	...
	(*ReplaceBlockMetadataRequest)(nil),     // 3: raft_log.ReplaceBlockMetadataRequest
	(*ReplaceBlockMetadataResponse)(nil),    // 4: raft_log.ReplaceBlockMetadataResponse
	(*GetCompactionPlanUpdateRequest)(nil),  // 5: raft_log.GetCompactionPlanUpdateRequest
	(*GetCompactionPlanUpdateResponse)(nil), // 6: raft_log.GetCompactionPlanUpdateResponse
	(*CompactionPlanUpdate)(nil),            // 7: raft_log.CompactionPlanUpdate
	(*CompactionJobState)(nil),              // 8: raft_log.CompactionJobState
	(*CompactionJobPlan)(nil),               // 9: raft_log.CompactionJobPlan
	(*UpdateCompactionPlanRequest)(nil),     // 10: raft_log.UpdateCompactionPlanRequest
	(*UpdateCompactionPlanResponse)(nil),    // 11: raft_log.UpdateCompactionPlanResponse
	(*v1.BlockMeta)(nil),                    // 12: metastore.v1.BlockMeta
	(*v1.CompactionJobStatusUpdate)(nil),    // 13: metastore.v1.CompactionJobStatusUpdate
	(v1.CompactionJobStatus)(0),             // 14: metastore.v1.CompactionJobStatus
}
var file_metastore_v1_raft_log_raft_log_proto_depIdxs = []int32{
	12, // 0: raft_log.AddBlockMetadataRequest.metadata:type_name -> metastore.v1.BlockMeta
	12, // 1: raft_log.ReplaceBlockMetadataRequest.new_blocks:type_name -> metastore.v1.BlockMeta
	13, // 2: raft_log.GetCompactionPlanUpdateRequest.status_updates:type_name -> metastore.v1.CompactionJobStatusUpdate
	7,  // 3: raft_log.GetCompactionPlanUpdateResponse.plan_update:type_name -> raft_log.CompactionPlanUpdate
	9,  // 4: raft_log.CompactionPlanUpdate.new_jobs:type_name -> raft_log.CompactionJobPlan
	8,  // 5: raft_log.CompactionPlanUpdate.schedule_updates:type_name -> raft_log.CompactionJobState
	14, // 6: raft_log.CompactionJobState.status:type_name -> metastore.v1.CompactionJobStatus
	12, // 7: raft_log.CompactionJobPlan.compacted_blocks:type_name -> metastore.v1.BlockMeta
	7,  // 8: raft_log.UpdateCompactionPlanRequest.plan_update:type_name -> raft_log.CompactionPlanUpdate
...
func file_metastore_v1_raft_log_raft_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_metastore_v1_raft_log_raft_log_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ReplaceBlockMetadataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_metastore_v1_raft_log_raft_log_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*ReplaceBlockMetadataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
