...
type CompactionPlanUpdate struct {
	...
	NewJobs       []*CompactionJobUpdate `protobuf:"bytes,1,rep,name=new_jobs,json=newJobs,proto3" json:"new_jobs,omitempty"`
	AssignedJobs  []*CompactionJobUpdate `protobuf:"bytes,2,rep,name=assigned_jobs,json=assignedJobs,proto3" json:"assigned_jobs,omitempty"`
	CompletedJobs []*CompactionJobUpdate `protobuf:"bytes,3,rep,name=completed_jobs,json=completedJobs,proto3" json:"completed_jobs,omitempty"`
}
...
func (x *CompactionPlanUpdate) GetNewJobs() []*CompactionJobUpdate {
	if x != nil {
		return x.NewJobs
	}
	return nil
...
func (x *CompactionPlanUpdate) GetAssignedJobs() []*CompactionJobUpdate {
	if x != nil {
...
func (x *CompactionPlanUpdate) GetCompletedJobs() []*CompactionJobUpdate {
	if x != nil {
...
type CompactionJobUpdate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CompactionJobUpdate) Reset() {
	*x = CompactionJobUpdate{}
	if protoimpl.UnsafeEnabled {
...
func (x *CompactionJobUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompactionJobUpdate) ProtoMessage() {}

func (x *CompactionJobUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_metastore_v1_raft_log_raft_log_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompactionJobUpdate.ProtoReflect.Descriptor instead.
func (*CompactionJobUpdate) Descriptor() ([]byte, []int) {
	return file_metastore_v1_raft_log_raft_log_proto_rawDescGZIP(), []int{5}
}

func (x *CompactionJobUpdate) GetState() *CompactionJobState {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *CompactionJobUpdate) GetPlan() *CompactionJobPlan {
	if x != nil {
		return x.Plan
	}
	return nil
...
type CompactionJobState struct {
	...
	CompactionLevel uint32                 `protobuf:"varint,2,opt,name=compaction_level,json=compactionLevel,proto3" json:"compaction_level,omitempty"` // TODO: remove.
...
type CompactionJobPlan struct {
	...
	Tombstones *v1.Tombstones `protobuf:"bytes,6,opt,name=tombstones,proto3" json:"tombstones,omitempty"`
	// Only present if the job completed successfully.
	CompactedBlocks []*v1.BlockMeta `protobuf:"bytes,7,rep,name=compacted_blocks,json=compactedBlocks,proto3" json:"compacted_blocks,omitempty"`
}
...
var file_metastore_v1_raft_log_raft_log_proto_rawDesc = []byte{
	...
	0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x98, 0x01, 0x0a, 0x1e, 0x47, 0x65, 0x74,
	...
	,
	...
	0x72, 0x61, 0x66, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x4a, 0x6f, 0x62, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x04, 0x70, 0x6c, 0x61, 0x6e,
	...
	0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x73, 0x22, 0xa3, 0x02, 0x0a, 0x11, 0x43, 0x6f, 0x6d,
	...
	,
	...
	0x2f, 0x67, 0x6f, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x76, 0x31,
	0x2f, 0x72, 0x61, 0x66, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0xa2, 0x02, 0x03, 0x52, 0x58, 0x58, 0xaa,
	0x02, 0x07, 0x52, 0x61, 0x66, 0x74, 0x4c, 0x6f, 0x67, 0xca, 0x02, 0x07, 0x52, 0x61, 0x66, 0x74,
	0x4c, 0x6f, 0x67, 0xe2, 0x02, 0x13, 0x52, 0x61, 0x66, 0x74, 0x4c, 0x6f, 0x67, 0x5c, 0x47, 0x50,
	0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x07, 0x52, 0x61, 0x66, 0x74,
...
var file_metastore_v1_raft_log_raft_log_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_metastore_v1_raft_log_raft_log_proto_goTypes = []any{
	...
	(*CompactionJobUpdate)(nil),             // 6: raft_log.CompactionJobUpdate
	(*CompactionJobState)(nil),              // 7: raft_log.CompactionJobState
	(*CompactionJobPlan)(nil),               // 8: raft_log.CompactionJobPlan
	(*UpdateCompactionPlanRequest)(nil),     // 9: raft_log.UpdateCompactionPlanRequest
	(*UpdateCompactionPlanResponse)(nil),    // 10: raft_log.UpdateCompactionPlanResponse
	(*v1.BlockMeta)(nil),                    // 11: metastore.v1.BlockMeta
	(*v1.CompactionJobStatusUpdate)(nil),    // 12: metastore.v1.CompactionJobStatusUpdate
	(v1.CompactionJobStatus)(0),             // 13: metastore.v1.CompactionJobStatus
	(*v1.Tombstones)(nil),                   // 14: metastore.v1.Tombstones
}
var file_metastore_v1_raft_log_raft_log_proto_depIdxs = []int32{
	11, // 0: raft_log.AddBlockMetadataRequest.metadata:type_name -> metastore.v1.BlockMeta
	12, // 1: raft_log.GetCompactionPlanUpdateRequest.status_updates:type_name -> metastore.v1.CompactionJobStatusUpdate
	5,  // 2: raft_log.GetCompactionPlanUpdateResponse.plan_update:type_name -> raft_log.CompactionPlanUpdate
	6,  // 3: raft_log.CompactionPlanUpdate.new_jobs:type_name -> raft_log.CompactionJobUpdate
	6,  // 4: raft_log.CompactionPlanUpdate.assigned_jobs:type_name -> raft_log.CompactionJobUpdate
	6,  // 5: raft_log.CompactionPlanUpdate.completed_jobs:type_name -> raft_log.CompactionJobUpdate
	7,  // 6: raft_log.CompactionJobUpdate.state:type_name -> raft_log.CompactionJobState
	8,  // 7: raft_log.CompactionJobUpdate.plan:type_name -> raft_log.CompactionJobPlan
	13, // 8: raft_log.CompactionJobState.status:type_name -> metastore.v1.CompactionJobStatus
	14, // 9: raft_log.CompactionJobPlan.tombstones:type_name -> metastore.v1.Tombstones
	11, // 10: raft_log.CompactionJobPlan.compacted_blocks:type_name -> metastore.v1.BlockMeta
	5,  // 11: raft_log.UpdateCompactionPlanRequest.plan_update:type_name -> raft_log.CompactionPlanUpdate
...
func file_metastore_v1_raft_log_raft_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_metastore_v1_raft_log_raft_log_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*CompactionJobUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
