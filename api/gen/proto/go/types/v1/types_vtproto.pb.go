...
func (m *GetFeatureFlagsResponse) CloneVT() *GetFeatureFlagsResponse {
	...
	if rhs := m.Features; rhs != nil {
		tmpContainer := make(map[string]*FeatureParameters, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *FeatureParameters) CloneVT() *FeatureParameters {
	if m == nil {
		return (*FeatureParameters)(nil)
	}
	r := new(FeatureParameters)
	r.Enabled = m.Enabled
...
func (m *FeatureParameters) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *FeatureParameters) EqualVT(that *FeatureParameters) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *FeatureParameters) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FeatureParameters)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *FeatureParameters) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FeatureParameters) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FeatureParameters) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FeatureParameters) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetFeatureFlagsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Features == nil {
				m.Features = make(map[string]*FeatureParameters)
			}
			var mapkey string
			var mapvalue *FeatureParameters
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *FeatureParameters) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FeatureParameters: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FeatureParameters: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
