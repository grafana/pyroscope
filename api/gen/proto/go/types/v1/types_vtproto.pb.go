...
func (m *HeatmapSeries) CloneVT() *HeatmapSeries {
	...
	if rhs := m.Slots; rhs != nil {
		tmpContainer := make([]*HeatmapSlot, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *HeatmapSlot) CloneVT() *HeatmapSlot {
	if m == nil {
		return (*HeatmapSlot)(nil)
	}
	r := new(HeatmapSlot)
	r.Timestamp = m.Timestamp
...
func (m *HeatmapSlot) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *FunctionTable) CloneVT() *FunctionTable {
	if m == nil {
		return (*FunctionTable)(nil)
	}
	r := new(FunctionTable)
	r.Total = m.Total
	r.TotalFunctions = m.TotalFunctions
	if rhs := m.Functions; rhs != nil {
		tmpContainer := make([]*FunctionStats, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *FunctionTable) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *FunctionStats) CloneVT() *FunctionStats {
	if m == nil {
...
func (m *FunctionStats) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *FunctionTree) CloneVT() *FunctionTree {
	if m == nil {
		return (*FunctionTree)(nil)
	}
	r := new(FunctionTree)
	r.Callers = m.Callers.CloneVT()
	r.Callees = m.Callees.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *FunctionTree) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *CallTree) CloneVT() *CallTree {
	if m == nil {
		return (*CallTree)(nil)
	}
	r := new(CallTree)
...
func (m *CallTree) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *CallTreeNode) CloneVT() *CallTreeNode {
	if m == nil {
		return (*CallTreeNode)(nil)
	}
	r := new(CallTreeNode)
	r.Name = m.Name
	r.Total = m.Total
	r.Self = m.Self
	r.HasChildren = m.HasChildren
	if rhs := m.Children; rhs != nil {
		tmpContainer := make([]*CallTreeNode, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *CallTreeNode) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *FunctionTreeOptions) CloneVT() *FunctionTreeOptions {
	if m == nil {
		return (*FunctionTreeOptions)(nil)
	}
	r := new(FunctionTreeOptions)
	r.Direction = m.Direction
	r.Selection = m.Selection
...
func (m *FunctionTreeOptions) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *HeatmapSlot) EqualVT(that *HeatmapSlot) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.YMin) != len(that.YMin) {
		return false
	}
	for i, vx := range this.YMin {
		vy := that.YMin[i]
		if vx != vy {
			return false
		}
...
func (this *HeatmapSlot) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*HeatmapSlot)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *FunctionTable) EqualVT(that *FunctionTable) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.TotalFunctions != that.TotalFunctions {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *FunctionTable) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionTable)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *FunctionStats) EqualVT(that *FunctionStats) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *FunctionStats) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionStats)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *FunctionTree) EqualVT(that *FunctionTree) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if !this.Callers.EqualVT(that.Callers) {
		return false
	}
	if !this.Callees.EqualVT(that.Callees) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *FunctionTree) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionTree)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *CallTree) EqualVT(that *CallTree) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *CallTree) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CallTree)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *CallTreeNode) EqualVT(that *CallTreeNode) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *CallTreeNode) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CallTreeNode)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *FunctionTreeOptions) EqualVT(that *FunctionTreeOptions) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.Selection != that.Selection {
		return false
	}
...
func (this *FunctionTreeOptions) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionTreeOptions)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *HeatmapSlot) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *HeatmapSlot) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *HeatmapSlot) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.YMin) > 0 {
		for iNdEx := len(m.YMin) - 1; iNdEx >= 0; iNdEx-- {
			f3 := math.Float64bits(float64(m.YMin[iNdEx]))
			i -= 8
			binary.LittleEndian.PutUint64(dAtA[i:], uint64(f3))
		}
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.YMin)*8))
		i--
		dAtA[i] = 0x12
	}
	if m.Timestamp != 0 {
...
func (m *FunctionTable) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionTable) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionTable) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.TotalFunctions != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.TotalFunctions))
		i--
		dAtA[i] = 0x18
	}
	if m.Total != 0 {
...
func (m *FunctionStats) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionStats) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionStats) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Self != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Self))
		i--
		dAtA[i] = 0x18
	}
	if m.Total != 0 {
...
func (m *FunctionTree) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionTree) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionTree) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Callees != nil {
		size, err := m.Callees.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Callers != nil {
		size, err := m.Callers.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CallTree) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CallTree) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CallTree) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CallTreeNode) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CallTreeNode) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CallTreeNode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FunctionTreeOptions) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionTreeOptions) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionTreeOptions) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Selection != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Selection))
		i--
		dAtA[i] = 0x10
	}
	if m.Direction != 0 {
...
func (m *HeatmapSlot) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.YMin) > 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(len(m.YMin)*8)) + len(m.YMin)*8
	}
	if len(m.Counts) > 0 {
		l = 0
...
func (m *FunctionTable) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TotalFunctions != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.TotalFunctions))
	}
	n += len(m.unknownFields)
	return n
}

func (m *FunctionStats) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Self != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Self))
	}
	n += len(m.unknownFields)
	return n
}

func (m *FunctionTree) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CallTreeNode) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FunctionTreeOptions) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Selection != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Selection))
	}
	if m.MaxDepth != nil {
...
func (m *HeatmapSeries) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Slots = append(m.Slots, &HeatmapSlot{})
...
func (m *HeatmapSlot) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HeatmapSlot: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HeatmapSlot: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType == 1 {
				...
				if elementCount != 0 && len(m.YMin) == 0 {
					m.YMin = make([]float64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					if (iNdEx + 8) > l {
...
func (m *FunctionTable) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionTable: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionTable: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Functions = append(m.Functions, &FunctionStats{})
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalFunctions", wireType)
			}
			m.TotalFunctions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalFunctions |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *FunctionStats) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FunctionTree) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionTree: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionTree: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if err := m.Callers.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := m.Callees.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CallTree) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CallTree: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CallTree: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CallTreeNode) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CallTreeNode: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CallTreeNode: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			m.Children = append(m.Children, &CallTreeNode{})
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasChildren", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *FunctionTreeOptions) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionTreeOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionTreeOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Direction |= FunctionTreeDirection(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Selection |= FunctionTreeSelection(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
