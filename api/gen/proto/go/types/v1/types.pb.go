...
var file_types_v1_types_proto_goTypes = []interface{}{
	...
	(*BlockInfo)(nil),           // 9: types.v1.BlockInfo
	(*BlockCompaction)(nil),     // 10: types.v1.BlockCompaction
}
var file_types_v1_types_proto_depIdxs = []int32{
	...
	10, // 3: types.v1.BlockInfo.compaction:type_name -> types.v1.BlockCompaction
	0,  // 4: types.v1.BlockInfo.labels:type_name -> types.v1.LabelPair
