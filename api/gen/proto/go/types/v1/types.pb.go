...
type SeriesMetric int32

const (
	SeriesMetric_SERIES_METRIC_UNSPECIFIED     SeriesMetric = 0
	SeriesMetric_SERIES_METRIC_CALL_SITE_FLAT  SeriesMetric = 1
	SeriesMetric_SERIES_METRIC_CALL_SITE_TOTAL SeriesMetric = 2
	SeriesMetric_SERIES_METRIC_LOCATION_FLAT   SeriesMetric = 3
	SeriesMetric_SERIES_METRIC_LOCATION_TOTAL  SeriesMetric = 4
)

// Enum value maps for SeriesMetric.
var (
	SeriesMetric_name = map[int32]string{
		0: "SERIES_METRIC_UNSPECIFIED",
		1: "SERIES_METRIC_CALL_SITE_FLAT",
		2: "SERIES_METRIC_CALL_SITE_TOTAL",
		3: "SERIES_METRIC_LOCATION_FLAT",
		4: "SERIES_METRIC_LOCATION_TOTAL",
	}
	SeriesMetric_value = map[string]int32{
		"SERIES_METRIC_UNSPECIFIED":     0,
		"SERIES_METRIC_CALL_SITE_FLAT":  1,
		"SERIES_METRIC_CALL_SITE_TOTAL": 2,
		"SERIES_METRIC_LOCATION_FLAT":   3,
		"SERIES_METRIC_LOCATION_TOTAL":  4,
	}
)

func (x SeriesMetric) Enum() *SeriesMetric {
	p := new(SeriesMetric)
	*p = x
	return p
}

func (x SeriesMetric) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SeriesMetric) Descriptor() protoreflect.EnumDescriptor {
	return file_types_v1_types_proto_enumTypes[1].Descriptor()
}

func (SeriesMetric) Type() protoreflect.EnumType {
	return &file_types_v1_types_proto_enumTypes[1]
}

func (x SeriesMetric) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SeriesMetric.Descriptor instead.
func (SeriesMetric) EnumDescriptor() ([]byte, []int) {
...
type StackTraceSelector struct {
	...
	// Only stack traces that belong to the subtree (having the prefix
	// provided) will be selected. If empty, the filter is ignored.
	// Subtree root location (the call site) is the last element.
	SubtreeRoot []*Location `protobuf:"bytes,1,rep,name=subtree_root,json=subtreeRoot,proto3" json:"subtree_root,omitempty"`
}
...
func (x *StackTraceSelector) GetSubtreeRoot() []*Location {
	if x != nil {
...
var file_types_v1_types_proto_rawDesc = []byte{
	...
	,
...
var file_types_v1_types_proto_goTypes = []interface{}{
	...
	(SeriesMetric)(0),              // 1: types.v1.SeriesMetric
...
var file_types_v1_types_proto_depIdxs = []int32{
	...
	12, // 3: types.v1.BlockInfo.compaction:type_name -> types.v1.BlockCompaction
	2,  // 4: types.v1.BlockInfo.labels:type_name -> types.v1.LabelPair
	14, // 5: types.v1.StackTraceSelector.subtree_root:type_name -> types.v1.Location
