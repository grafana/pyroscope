...
type SelectSpanProfileRequest struct {
	...
	Start         int64           `protobuf:"varint,3,opt,name=start,proto3" json:"start,omitempty"`
	End           int64           `protobuf:"varint,4,opt,name=end,proto3" json:"end,omitempty"`
	SpanSelector  []byte          `protobuf:"bytes,5,opt,name=span_selector,json=spanSelector,proto3" json:"span_selector,omitempty"`
}
...
func (x *SelectSpanProfileRequest) GetSpanSelector() []byte {
	if x != nil {
...
var file_ingester_v1_ingester_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c,
