...
var file_storegateway_v1_storegateway_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf7, 0x04, 0x0a, 0x13, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x47, 0x61,
...
var file_storegateway_v1_storegateway_proto_goTypes = []interface{}{
	...
	(*v1.SeriesRequest)(nil),                    // 4: ingester.v1.SeriesRequest
	(*v1.BlockMetadataRequest)(nil),             // 5: ingester.v1.BlockMetadataRequest
	(*v1.MergeProfilesStacktracesResponse)(nil), // 6: ingester.v1.MergeProfilesStacktracesResponse
	(*v1.MergeProfilesLabelsResponse)(nil),      // 7: ingester.v1.MergeProfilesLabelsResponse
	(*v1.MergeProfilesPprofResponse)(nil),       // 8: ingester.v1.MergeProfilesPprofResponse
	(*v1.MergeSpanProfileResponse)(nil),         // 9: ingester.v1.MergeSpanProfileResponse
	(*v1.SeriesResponse)(nil),                   // 10: ingester.v1.SeriesResponse
	(*v1.BlockMetadataResponse)(nil),            // 11: ingester.v1.BlockMetadataResponse
}
var file_storegateway_v1_storegateway_proto_depIdxs = []int32{
	...
	4,  // 4: storegateway.v1.StoreGatewayService.Series:input_type -> ingester.v1.SeriesRequest
	5,  // 5: storegateway.v1.StoreGatewayService.BlockMetadata:input_type -> ingester.v1.BlockMetadataRequest
	6,  // 6: storegateway.v1.StoreGatewayService.MergeProfilesStacktraces:output_type -> ingester.v1.MergeProfilesStacktracesResponse
	7,  // 7: storegateway.v1.StoreGatewayService.MergeProfilesLabels:output_type -> ingester.v1.MergeProfilesLabelsResponse
	8,  // 8: storegateway.v1.StoreGatewayService.MergeProfilesPprof:output_type -> ingester.v1.MergeProfilesPprofResponse
	9,  // 9: storegateway.v1.StoreGatewayService.MergeSpanProfile:output_type -> ingester.v1.MergeSpanProfileResponse
	10, // 10: storegateway.v1.StoreGatewayService.Series:output_type -> ingester.v1.SeriesResponse
	11, // 11: storegateway.v1.StoreGatewayService.BlockMetadata:output_type -> ingester.v1.BlockMetadataResponse
