...
var file_storegateway_v1_storegateway_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb6, 0x05, 0x0a, 0x13, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x47, 0x61,
	...
	0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0xd3, 0x01,
	0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x2e, 0x76, 0x31, 0x42, 0x11, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4c, 0x67, 0x69, 0x74, 0x68,
	...
	,
...
var file_storegateway_v1_storegateway_proto_goTypes = []interface{}{
	...
	(*v11.LabelValuesRequest)(nil),              // 4: types.v1.LabelValuesRequest
	(*v11.LabelNamesRequest)(nil),               // 5: types.v1.LabelNamesRequest
	(*v1.SeriesRequest)(nil),                    // 6: ingester.v1.SeriesRequest
	(*v1.MergeProfilesStacktracesResponse)(nil), // 7: ingester.v1.MergeProfilesStacktracesResponse
	(*v1.MergeProfilesLabelsResponse)(nil),      // 8: ingester.v1.MergeProfilesLabelsResponse
	(*v1.MergeProfilesPprofResponse)(nil),       // 9: ingester.v1.MergeProfilesPprofResponse
	(*v1.MergeSpanProfileResponse)(nil),         // 10: ingester.v1.MergeSpanProfileResponse
	(*v11.LabelValuesResponse)(nil),             // 11: types.v1.LabelValuesResponse
	(*v11.LabelNamesResponse)(nil),              // 12: types.v1.LabelNamesResponse
	(*v1.SeriesResponse)(nil),                   // 13: ingester.v1.SeriesResponse
}
var file_storegateway_v1_storegateway_proto_depIdxs = []int32{
	...
	4,  // 4: storegateway.v1.StoreGatewayService.LabelValues:input_type -> types.v1.LabelValuesRequest
	5,  // 5: storegateway.v1.StoreGatewayService.LabelNames:input_type -> types.v1.LabelNamesRequest
	6,  // 6: storegateway.v1.StoreGatewayService.Series:input_type -> ingester.v1.SeriesRequest
	7,  // 7: storegateway.v1.StoreGatewayService.MergeProfilesStacktraces:output_type -> ingester.v1.MergeProfilesStacktracesResponse
	8,  // 8: storegateway.v1.StoreGatewayService.MergeProfilesLabels:output_type -> ingester.v1.MergeProfilesLabelsResponse
	9,  // 9: storegateway.v1.StoreGatewayService.MergeProfilesPprof:output_type -> ingester.v1.MergeProfilesPprofResponse
	10, // 10: storegateway.v1.StoreGatewayService.MergeSpanProfile:output_type -> ingester.v1.MergeSpanProfileResponse
	11, // 11: storegateway.v1.StoreGatewayService.LabelValues:output_type -> types.v1.LabelValuesResponse
	12, // 12: storegateway.v1.StoreGatewayService.LabelNames:output_type -> types.v1.LabelNamesResponse
	13, // 13: storegateway.v1.StoreGatewayService.Series:output_type -> ingester.v1.SeriesResponse
