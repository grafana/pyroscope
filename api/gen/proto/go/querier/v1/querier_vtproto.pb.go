...
func (m *SelectMergeStacktracesRequest) CloneVT() *SelectMergeStacktracesRequest {
	...
	if rhs := m.SandwichFunction; rhs != nil {
		tmpVal := *rhs
		r.SandwichFunction = &tmpVal
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *FunctionTable) CloneVT() *FunctionTable {
	...
	if rhs := m.Functions; rhs != nil {
		tmpContainer := make([]*FunctionRow, len(rhs))
		for k, v := range rhs {
...
func (m *FunctionRow) CloneVT() *FunctionRow {
	if m == nil {
		return (*FunctionRow)(nil)
	}
	r := new(FunctionRow)
	r.Name = m.Name
	r.Self = m.Self
...
func (m *FunctionRow) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *SandwichNode) CloneVT() *SandwichNode {
	if m == nil {
		return (*SandwichNode)(nil)
	}
	r := new(SandwichNode)
	r.NameIndex = m.NameIndex
	r.Total = m.Total
	r.Self = m.Self
	r.Truncated = m.Truncated
	if rhs := m.Children; rhs != nil {
		tmpContainer := make([]*SandwichNode, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *SandwichNode) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *SelectMergeStacktracesRequest) EqualVT(that *SelectMergeStacktracesRequest) bool {
	...
	if p, q := this.SandwichFunction, that.SandwichFunction; (p == nil && q != nil) || (p != nil && (q == nil || *p != *q)) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *FunctionRow) EqualVT(that *FunctionRow) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *FunctionRow) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionRow)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *SandwichNode) EqualVT(that *SandwichNode) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if this.NameIndex != that.NameIndex {
		return false
	}
	if this.Total != that.Total {
		return false
...
func (this *SandwichNode) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*SandwichNode)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *SelectMergeStacktracesRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.SandwichFunction != nil {
		i -= len(*m.SandwichFunction)
		copy(dAtA[i:], *m.SandwichFunction)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(*m.SandwichFunction)))
		i--
		dAtA[i] = 0x62
	}
...
func (m *FunctionRow) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionRow) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionRow) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *SandwichNode) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *SandwichNode) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *SandwichNode) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.NameIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.NameIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *FunctionRow) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SandwichNode) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NameIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.NameIndex))
	}
	if m.Total != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Total))
	}
...
func (m *SelectMergeStacktracesRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SandwichFunction", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *FunctionTable) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Functions = append(m.Functions, &FunctionRow{})
...
func (m *FunctionRow) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionRow: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionRow: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SandwichNode) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SandwichNode: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SandwichNode: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NameIndex |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			...
			m.Children = append(m.Children, &SandwichNode{})
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= AsyncQueryType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
