...
// period.
const (
	// SettingsServiceAllProcedure is the fully-qualified name of the SettingsService's All RPC.
	SettingsServiceAllProcedure = "/settings.v1.SettingsService/All"
...
type SettingsServiceClient interface {
	All(context.Context, *connect_go.Request[v1.AllSettingsRequest]) (*connect_go.Response[v1.AllSettingsResponse], error)
...
func NewSettingsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) SettingsServiceClient {
	...
	return &settingsServiceClient{
		all: connect_go.NewClient[v1.AllSettingsRequest, v1.AllSettingsResponse](
			httpClient,
			baseURL+SettingsServiceAllProcedure,
			opts...,
		),
...
type settingsServiceClient struct {
	all *connect_go.Client[v1.AllSettingsRequest, v1.AllSettingsResponse]
	set *connect_go.Client[v1.SetSettingsRequest, v1.SetSettingsResponse]
}

// All calls settings.v1.SettingsService.All.
func (c *settingsServiceClient) All(ctx context.Context, req *connect_go.Request[v1.AllSettingsRequest]) (*connect_go.Response[v1.AllSettingsResponse], error) {
...
func NewSettingsServiceHandler(svc SettingsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	settingsServiceAllHandler := connect_go.NewUnaryHandler(
		SettingsServiceAllProcedure,
		svc.All,
		opts...,
	)
	...
	return "/settings.v1.SettingsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case SettingsServiceAllProcedure:
			settingsServiceAllHandler.ServeHTTP(w, r)
...
func (UnimplementedSettingsServiceHandler) All(context.Context, *connect_go.Request[v1.AllSettingsRequest]) (*connect_go.Response[v1.AllSettingsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("settings.v1.SettingsService.All is not implemented"))
}
