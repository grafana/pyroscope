...
func (m *AllSettingsRequest) CloneVT() *AllSettingsRequest {
	if m == nil {
		return (*AllSettingsRequest)(nil)
	}
	r := &AllSettingsRequest{}
...
func (m *AllSettingsRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AllSettingsResponse) CloneVT() *AllSettingsResponse {
	if m == nil {
		return (*AllSettingsResponse)(nil)
	}
	r := &AllSettingsResponse{}
...
func (m *AllSettingsResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
type SettingsServiceClient interface {
	All(ctx context.Context, in *AllSettingsRequest, opts ...grpc.CallOption) (*AllSettingsResponse, error)
...
func (c *settingsServiceClient) All(ctx context.Context, in *AllSettingsRequest, opts ...grpc.CallOption) (*AllSettingsResponse, error) {
	out := new(AllSettingsResponse)
	err := c.cc.Invoke(ctx, "/settings.v1.SettingsService/All", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SettingsServiceServer interface {
	All(context.Context, *AllSettingsRequest) (*AllSettingsResponse, error)
...
func (UnimplementedSettingsServiceServer) All(context.Context, *AllSettingsRequest) (*AllSettingsResponse, error) {
...
func _SettingsService_All_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AllSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingsServiceServer).All(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/settings.v1.SettingsService/All",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingsServiceServer).All(ctx, req.(*AllSettingsRequest))
	}
...
var SettingsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "All",
			Handler:    _SettingsService_All_Handler,
		},
		{
			MethodName: "Set",
...
func (m *AllSettingsRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AllSettingsRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AllSettingsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AllSettingsResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AllSettingsResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AllSettingsResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AllSettingsRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AllSettingsResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AllSettingsRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: AllSettingsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AllSettingsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *AllSettingsResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AllSettingsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AllSettingsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
