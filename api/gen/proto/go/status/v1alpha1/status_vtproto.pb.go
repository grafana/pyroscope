...
func (c *statusServiceClient) GetBuildInfo(ctx context.Context, in *GetBuildInfoRequest, opts ...grpc.CallOption) (*GetBuildInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/status.v1alpha1.StatusService/GetBuildInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusServiceClient) GetConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error) {
	...
	err := c.cc.Invoke(ctx, "/status.v1alpha1.StatusService/GetConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusServiceClient) GetDiffConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error) {
	out := new(httpbody.HttpBody)
	err := c.cc.Invoke(ctx, "/status.v1alpha1.StatusService/GetDiffConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusServiceClient) GetDefaultConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error) {
	out := new(httpbody.HttpBody)
	err := c.cc.Invoke(ctx, "/status.v1alpha1.StatusService/GetDefaultConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatusService_GetBuildInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.v1alpha1.StatusService/GetBuildInfo",
	}
...
func _StatusService_GetConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.v1alpha1.StatusService/GetConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatusService_GetDiffConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.v1alpha1.StatusService/GetDiffConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatusService_GetDefaultConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/status.v1alpha1.StatusService/GetDefaultConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var StatusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "status.v1alpha1.StatusService",
	...
	Metadata: "status/v1alpha1/status.proto",
}
