...
func (m *GetBuildInfoData) CloneVT() *GetBuildInfoData {
	...
	r := new(GetBuildInfoData)
	r.Version = m.Version
	r.Revision = m.Revision
	r.Branch = m.Branch
	r.BuildUser = m.BuildUser
...
func (m *GetBuildInfoData) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.BuildUser) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.BuildUser)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Branch) > 0 {
...
func (m *GetBuildInfoRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *GetBuildInfoResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *GetBuildInfoData) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *GetConfigRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *GetConfigResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
