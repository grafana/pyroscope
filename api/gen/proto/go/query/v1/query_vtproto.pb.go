...
func (m *FunctionTreeQuery) CloneVT() *FunctionTreeQuery {
	if m == nil {
		return (*FunctionTreeQuery)(nil)
	}
	r := new(FunctionTreeQuery)
	if rhs := m.StackTraceSelector; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface {
			CloneVT() *v11.StackTraceSelector
		}); ok {
	...
	if rhs := m.Options; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface {
			CloneVT() *v11.FunctionTreeOptions
		}); ok {
			r.Options = vtpb.CloneVT()
		} else {
			r.Options = proto.Clone(rhs).(*v11.FunctionTreeOptions)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *FunctionTreeQuery) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *FunctionTreeReport) CloneVT() *FunctionTreeReport {
	if m == nil {
		return (*FunctionTreeReport)(nil)
	}
	r := new(FunctionTreeReport)
	r.Query = m.Query.CloneVT()
	if rhs := m.Tree; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *v11.FunctionTree }); ok {
			r.Tree = vtpb.CloneVT()
		} else {
			r.Tree = proto.Clone(rhs).(*v11.FunctionTree)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *FunctionTreeReport) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *FunctionTreeQuery) EqualVT(that *FunctionTreeQuery) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if equal, ok := interface{}(this.Options).(interface {
		EqualVT(*v11.FunctionTreeOptions) bool
	}); ok {
...
func (this *FunctionTreeQuery) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionTreeQuery)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *FunctionTreeReport) EqualVT(that *FunctionTreeReport) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if equal, ok := interface{}(this.Tree).(interface{ EqualVT(*v11.FunctionTree) bool }); ok {
		if !equal.EqualVT(that.Tree) {
			return false
		}
	} else if !proto.Equal(this.Tree, that.Tree) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *FunctionTreeReport) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FunctionTreeReport)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *FunctionTreeQuery) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionTreeQuery) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionTreeQuery) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FunctionTreeReport) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FunctionTreeReport) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FunctionTreeReport) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Tree != nil {
		if vtmsg, ok := interface{}(m.Tree).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.Tree)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *FunctionTreeQuery) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FunctionTreeReport) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Tree != nil {
		if size, ok := interface{}(m.Tree).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
...
func (m *Query) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if m.FunctionTree == nil {
				m.FunctionTree = &FunctionTreeQuery{}
			}
...
func (m *Report) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			if m.FunctionTree == nil {
				m.FunctionTree = &FunctionTreeReport{}
			}
			if err := m.FunctionTree.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *FunctionTreeQuery) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionTreeQuery: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionTreeQuery: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			if m.Options == nil {
				m.Options = &v11.FunctionTreeOptions{}
			}
...
func (m *FunctionTreeReport) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FunctionTreeReport: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FunctionTreeReport: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.Tree == nil {
				m.Tree = &v11.FunctionTree{}
			}
			if unmarshal, ok := interface{}(m.Tree).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Tree); err != nil {
					return err
				}
			}
			iNdEx = postIndex
