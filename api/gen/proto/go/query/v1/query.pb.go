...
const file_query_v1_query_proto_rawDesc = "" +
	...
	" \x01(\v2\x1d.query.v1.SymbolServicesQueryR\x0esymbolServices\"u\n" +
	...
	"\x10compaction_level\x18\a \x01(\rR\x0fcompactionLevel\"\xe2\x04\n" +
	"\x06Report\x125\n" +
	...
	"\x0fsymbol_services\x18\n" +
	" \x01(\v2\x1e.query.v1.SymbolServicesReportR\x0esymbolServices\"8\n" +
	"\x13SymbolServicesQuery\x12!\n" +
	"\fsymbol_names\x18\x01 \x03(\tR\vsymbolNames\"\xa1\x01\n" +
	...
	"timeSeries\x12A\n" +
	"\x0fattribute_table\x18\x03 \x01(\v2\x18.query.v1.AttributeTableR\x0eattributeTable*\xef\x01\n" +
	"\tQueryType\x12\x15\n" +
	...
	"\x15QUERY_SYMBOL_SERVICES\x10\t*\xfa\x01\n" +
	"\n" +
	"ReportType\x12\x16\n" +
	...
	"\x16REPORT_SYMBOL_SERVICES\x10\t2\xa9\x01\n" +
	"\x14QueryFrontendService\x12:\n" +
	"\x05Query\x12\x16.query.v1.QueryRequest\x1a\x17.query.v1.QueryResponse\"\x00\x12U\n" +
	"\x0eSymbolServices\x12\x1f.query.v1.SymbolServicesRequest\x1a .query.v1.SymbolServicesResponse\"\x002T\n" +
...
var file_query_v1_query_proto_goTypes = []any{
	...
	(*SymbolServicesReport)(nil),    // 19: query.v1.SymbolServicesReport
	(*SymbolServicesResult)(nil),    // 20: query.v1.SymbolServicesResult
	(*SymbolService)(nil),           // 21: query.v1.SymbolService
	(*LabelNamesQuery)(nil),         // 22: query.v1.LabelNamesQuery
	(*LabelNamesReport)(nil),        // 23: query.v1.LabelNamesReport
	(*LabelValuesQuery)(nil),        // 24: query.v1.LabelValuesQuery
	(*LabelValuesReport)(nil),       // 25: query.v1.LabelValuesReport
	(*SeriesLabelsQuery)(nil),       // 26: query.v1.SeriesLabelsQuery
	(*SeriesLabelsReport)(nil),      // 27: query.v1.SeriesLabelsReport
	(*TimeSeriesQuery)(nil),         // 28: query.v1.TimeSeriesQuery
	(*TimeSeriesReport)(nil),        // 29: query.v1.TimeSeriesReport
	(*TreeQuery)(nil),               // 30: query.v1.TreeQuery
	(*TreeSymbols)(nil),             // 31: query.v1.TreeSymbols
	(*TreeReport)(nil),              // 32: query.v1.TreeReport
	...
	(*v11.StackTraceSelector)(nil),  // 48: types.v1.StackTraceSelector
	(*v12.Mapping)(nil),             // 49: google.v1.Mapping
	(*v12.Location)(nil),            // 50: google.v1.Location
	(*v12.Function)(nil),            // 51: google.v1.Function
...
var file_query_v1_query_proto_depIdxs = []int32{
	...
	20, // 2: query.v1.SymbolServicesResponse.results:type_name -> query.v1.SymbolServicesResult
	...
	44, // 9: query.v1.QueryNode.blocks:type_name -> metastore.v1.BlockMeta
	0,  // 10: query.v1.Query.query_type:type_name -> query.v1.QueryType
	22, // 11: query.v1.Query.label_names:type_name -> query.v1.LabelNamesQuery
	24, // 12: query.v1.Query.label_values:type_name -> query.v1.LabelValuesQuery
	26, // 13: query.v1.Query.series_labels:type_name -> query.v1.SeriesLabelsQuery
	28, // 14: query.v1.Query.time_series:type_name -> query.v1.TimeSeriesQuery
	30, // 15: query.v1.Query.tree:type_name -> query.v1.TreeQuery
	33, // 16: query.v1.Query.pprof:type_name -> query.v1.PprofQuery
	35, // 17: query.v1.Query.heatmap:type_name -> query.v1.HeatmapQuery
	28, // 18: query.v1.Query.time_series_compact:type_name -> query.v1.TimeSeriesQuery
	18, // 19: query.v1.Query.symbol_services:type_name -> query.v1.SymbolServicesQuery
	17, // 20: query.v1.InvokeResponse.reports:type_name -> query.v1.Report
	13, // 21: query.v1.InvokeResponse.diagnostics:type_name -> query.v1.Diagnostics
	9,  // 22: query.v1.Diagnostics.query_plan:type_name -> query.v1.QueryPlan
	...
	23, // 29: query.v1.Report.label_names:type_name -> query.v1.LabelNamesReport
	25, // 30: query.v1.Report.label_values:type_name -> query.v1.LabelValuesReport
	27, // 31: query.v1.Report.series_labels:type_name -> query.v1.SeriesLabelsReport
	29, // 32: query.v1.Report.time_series:type_name -> query.v1.TimeSeriesReport
	32, // 33: query.v1.Report.tree:type_name -> query.v1.TreeReport
	...
	19, // 37: query.v1.Report.symbol_services:type_name -> query.v1.SymbolServicesReport
	18, // 38: query.v1.SymbolServicesReport.query:type_name -> query.v1.SymbolServicesQuery
	20, // 39: query.v1.SymbolServicesReport.results:type_name -> query.v1.SymbolServicesResult
	21, // 40: query.v1.SymbolServicesResult.services:type_name -> query.v1.SymbolService
	22, // 41: query.v1.LabelNamesReport.query:type_name -> query.v1.LabelNamesQuery
	24, // 42: query.v1.LabelValuesReport.query:type_name -> query.v1.LabelValuesQuery
	26, // 43: query.v1.SeriesLabelsReport.query:type_name -> query.v1.SeriesLabelsQuery
	45, // 44: query.v1.SeriesLabelsReport.series_labels:type_name -> types.v1.Labels
	46, // 45: query.v1.TimeSeriesQuery.exemplar_type:type_name -> types.v1.ExemplarType
	28, // 46: query.v1.TimeSeriesReport.query:type_name -> query.v1.TimeSeriesQuery
	47, // 47: query.v1.TimeSeriesReport.time_series:type_name -> types.v1.Series
	48, // 48: query.v1.TreeQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	49, // 49: query.v1.TreeSymbols.mappings:type_name -> google.v1.Mapping
	50, // 50: query.v1.TreeSymbols.locations:type_name -> google.v1.Location
	51, // 51: query.v1.TreeSymbols.functions:type_name -> google.v1.Function
	30, // 52: query.v1.TreeReport.query:type_name -> query.v1.TreeQuery
	31, // 53: query.v1.TreeReport.symbols:type_name -> query.v1.TreeSymbols
	48, // 54: query.v1.PprofQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	33, // 55: query.v1.PprofReport.query:type_name -> query.v1.PprofQuery
	52, // 56: query.v1.HeatmapQuery.query_type:type_name -> querier.v1.HeatmapQueryType
	46, // 57: query.v1.HeatmapQuery.exemplar_type:type_name -> types.v1.ExemplarType
	37, // 58: query.v1.HeatmapSeries.points:type_name -> query.v1.HeatmapPoint
	35, // 59: query.v1.HeatmapReport.query:type_name -> query.v1.HeatmapQuery
	38, // 60: query.v1.HeatmapReport.heatmap_series:type_name -> query.v1.HeatmapSeries
	36, // 61: query.v1.HeatmapReport.attribute_table:type_name -> query.v1.AttributeTable
	40, // 62: query.v1.Point.exemplars:type_name -> query.v1.Exemplar
	41, // 63: query.v1.Series.points:type_name -> query.v1.Point
	28, // 64: query.v1.TimeSeriesCompactReport.query:type_name -> query.v1.TimeSeriesQuery
	42, // 65: query.v1.TimeSeriesCompactReport.time_series:type_name -> query.v1.Series
	36, // 66: query.v1.TimeSeriesCompactReport.attribute_table:type_name -> query.v1.AttributeTable
	3,  // 67: query.v1.QueryFrontendService.Query:input_type -> query.v1.QueryRequest
	5,  // 68: query.v1.QueryFrontendService.SymbolServices:input_type -> query.v1.SymbolServicesRequest
	8,  // 69: query.v1.QueryBackendService.Invoke:input_type -> query.v1.InvokeRequest
	4,  // 70: query.v1.QueryFrontendService.Query:output_type -> query.v1.QueryResponse
	6,  // 71: query.v1.QueryFrontendService.SymbolServices:output_type -> query.v1.SymbolServicesResponse
	12, // 72: query.v1.QueryBackendService.Invoke:output_type -> query.v1.InvokeResponse
