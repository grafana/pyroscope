...
const (
	...
	QueryType_QUERY_SYMBOL_SERVICES         QueryType = 9
	QueryType_QUERY_SYMBOL_BLOOM_CANDIDATES QueryType = 10
)
...
var (
	QueryType_name = map[int32]string{
		...
		9:  "QUERY_SYMBOL_SERVICES",
		10: "QUERY_SYMBOL_BLOOM_CANDIDATES",
	}
...
const (
	...
	ReportType_REPORT_SYMBOL_SERVICES         ReportType = 9
	ReportType_REPORT_SYMBOL_BLOOM_CANDIDATES ReportType = 10
)
...
var (
	ReportType_name = map[int32]string{
		...
		9:  "REPORT_SYMBOL_SERVICES",
		10: "REPORT_SYMBOL_BLOOM_CANDIDATES",
	}
	ReportType_value = map[string]int32{
		...
		"REPORT_SYMBOL_SERVICES":         9,
		"REPORT_SYMBOL_BLOOM_CANDIDATES": 10,
	}
)
...
func (QueryNode_Type) EnumDescriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{7, 0}
}
...
type SymbolServicesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StartTime     int64                  `protobuf:"varint,1,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	EndTime       int64                  `protobuf:"varint,2,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	LabelSelector string                 `protobuf:"bytes,3,opt,name=label_selector,json=labelSelector,proto3" json:"label_selector,omitempty"`
...
func (x *SymbolServicesRequest) Reset() {
	*x = SymbolServicesRequest{}
	mi := &file_query_v1_query_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolServicesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolServicesRequest) ProtoMessage() {}

func (x *SymbolServicesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolServicesRequest.ProtoReflect.Descriptor instead.
func (*SymbolServicesRequest) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{2}
}

func (x *SymbolServicesRequest) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *SymbolServicesRequest) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *SymbolServicesRequest) GetLabelSelector() string {
	if x != nil {
		return x.LabelSelector
	}
	return ""
...
func (x *SymbolServicesRequest) GetSymbolNames() []string {
	if x != nil {
...
type SymbolServicesResponse struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Results       []*SymbolServicesResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	Complete      bool                    `protobuf:"varint,2,opt,name=complete,proto3" json:"complete,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolServicesResponse) Reset() {
	*x = SymbolServicesResponse{}
	mi := &file_query_v1_query_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolServicesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolServicesResponse) ProtoMessage() {}

func (x *SymbolServicesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolServicesResponse.ProtoReflect.Descriptor instead.
func (*SymbolServicesResponse) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{3}
}

func (x *SymbolServicesResponse) GetResults() []*SymbolServicesResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *SymbolServicesResponse) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
type Query struct {
	...
	SymbolServices        *SymbolServicesQuery        `protobuf:"bytes,10,opt,name=symbol_services,json=symbolServices,proto3" json:"symbol_services,omitempty"`
	SymbolBloomCandidates *SymbolBloomCandidatesQuery `protobuf:"bytes,11,opt,name=symbol_bloom_candidates,json=symbolBloomCandidates,proto3" json:"symbol_bloom_candidates,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Query) GetSymbolServices() *SymbolServicesQuery {
	if x != nil {
		return x.SymbolServices
	}
	return nil
}

func (x *Query) GetSymbolBloomCandidates() *SymbolBloomCandidatesQuery {
	if x != nil {
		return x.SymbolBloomCandidates
	}
	return nil
}
...
type Diagnostics struct {
	...
	ExecutionNode *ExecutionNode         `protobuf:"bytes,2,opt,name=execution_node,json=executionNode,proto3" json:"execution_node,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Diagnostics) GetExecutionNode() *ExecutionNode {
	if x != nil {
...
type ExecutionNode struct {
	...
	Children      []*ExecutionNode       `protobuf:"bytes,5,rep,name=children,proto3" json:"children,omitempty"`
...
func (x *ExecutionNode) GetExecutor() string {
	if x != nil {
		return x.Executor
	}
	return ""
...
func (x *ExecutionNode) GetStartTimeNs() int64 {
	if x != nil {
...
func (x *ExecutionNode) GetEndTimeNs() int64 {
	if x != nil {
		return x.EndTimeNs
	}
	return 0
...
func (x *ExecutionNode) GetChildren() []*ExecutionNode {
	if x != nil {
		return x.Children
	}
	return nil
...
func (x *ExecutionNode) GetStats() *ExecutionStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
func (x *ExecutionNode) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ExecutionStats) GetDatasetsProcessed() int64 {
	if x != nil {
		return x.DatasetsProcessed
	}
	return 0
}

func (x *ExecutionStats) GetBlockExecutions() []*BlockExecution {
	if x != nil {
...
type BlockExecution struct {
	...
	DatasetsProcessed int64                  `protobuf:"varint,4,opt,name=datasets_processed,json=datasetsProcessed,proto3" json:"datasets_processed,omitempty"`
	Size              uint64                 `protobuf:"varint,5,opt,name=size,proto3" json:"size,omitempty"`
	Shard             uint32                 `protobuf:"varint,6,opt,name=shard,proto3" json:"shard,omitempty"`
	CompactionLevel   uint32                 `protobuf:"varint,7,opt,name=compaction_level,json=compactionLevel,proto3" json:"compaction_level,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *BlockExecution) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BlockExecution) GetStartTimeNs() int64 {
	if x != nil {
		return x.StartTimeNs
	}
	return 0
...
func (x *BlockExecution) GetEndTimeNs() int64 {
	if x != nil {
		return x.EndTimeNs
	}
	return 0
...
func (x *BlockExecution) GetDatasetsProcessed() int64 {
	if x != nil {
		return x.DatasetsProcessed
	}
	return 0
...
func (x *BlockExecution) GetSize() uint64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *BlockExecution) GetShard() uint32 {
	if x != nil {
		return x.Shard
	}
	return 0
...
func (x *BlockExecution) GetCompactionLevel() uint32 {
	if x != nil {
...
type Report struct {
	...
	SymbolServices        *SymbolServicesReport        `protobuf:"bytes,10,opt,name=symbol_services,json=symbolServices,proto3" json:"symbol_services,omitempty"`
	SymbolBloomCandidates *SymbolBloomCandidatesReport `protobuf:"bytes,11,opt,name=symbol_bloom_candidates,json=symbolBloomCandidates,proto3" json:"symbol_bloom_candidates,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *Report) GetSymbolServices() *SymbolServicesReport {
	if x != nil {
		return x.SymbolServices
	}
	return nil
...
func (x *Report) GetSymbolBloomCandidates() *SymbolBloomCandidatesReport {
	if x != nil {
		return x.SymbolBloomCandidates
	}
	return nil
...
type SymbolServicesQuery struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	SymbolNames   []string                `protobuf:"bytes,1,rep,name=symbol_names,json=symbolNames,proto3" json:"symbol_names,omitempty"`
	Candidates    []*SymbolBloomCandidate `protobuf:"bytes,2,rep,name=candidates,proto3" json:"candidates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolServicesQuery) Reset() {
	*x = SymbolServicesQuery{}
	mi := &file_query_v1_query_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolServicesQuery) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolServicesQuery) ProtoMessage() {}

func (x *SymbolServicesQuery) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolServicesQuery.ProtoReflect.Descriptor instead.
func (*SymbolServicesQuery) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{15}
}

func (x *SymbolServicesQuery) GetSymbolNames() []string {
	if x != nil {
		return x.SymbolNames
	}
	return nil
...
func (x *SymbolServicesQuery) GetCandidates() []*SymbolBloomCandidate {
	if x != nil {
		return x.Candidates
	}
	return nil
...
type SymbolBloomCandidatesQuery struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SymbolNames   []string               `protobuf:"bytes,1,rep,name=symbol_names,json=symbolNames,proto3" json:"symbol_names,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SymbolBloomCandidatesQuery) Reset() {
	*x = SymbolBloomCandidatesQuery{}
	mi := &file_query_v1_query_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolBloomCandidatesQuery) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolBloomCandidatesQuery) ProtoMessage() {}

func (x *SymbolBloomCandidatesQuery) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolBloomCandidatesQuery.ProtoReflect.Descriptor instead.
func (*SymbolBloomCandidatesQuery) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{16}
}

func (x *SymbolBloomCandidatesQuery) GetSymbolNames() []string {
	if x != nil {
		return x.SymbolNames
	}
	return nil
...
type SymbolBloomCandidatesReport struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Query         *SymbolBloomCandidatesQuery `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
	Candidates    []*SymbolBloomCandidate     `protobuf:"bytes,2,rep,name=candidates,proto3" json:"candidates,omitempty"`
...
func (x *SymbolBloomCandidatesReport) Reset() {
	*x = SymbolBloomCandidatesReport{}
	mi := &file_query_v1_query_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolBloomCandidatesReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolBloomCandidatesReport) ProtoMessage() {}

func (x *SymbolBloomCandidatesReport) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolBloomCandidatesReport.ProtoReflect.Descriptor instead.
func (*SymbolBloomCandidatesReport) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{17}
}

func (x *SymbolBloomCandidatesReport) GetQuery() *SymbolBloomCandidatesQuery {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *SymbolBloomCandidatesReport) GetCandidates() []*SymbolBloomCandidate {
	if x != nil {
		return x.Candidates
	}
	return nil
...
func (x *SymbolBloomCandidatesReport) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
type SymbolBloomCandidate struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	BlockId             string                 `protobuf:"bytes,1,opt,name=block_id,json=blockId,proto3" json:"block_id,omitempty"`
	...
	MaxTime             int64                  `protobuf:"varint,6,opt,name=max_time,json=maxTime,proto3" json:"max_time,omitempty"`
	SymbolCountEstimate uint32                 `protobuf:"varint,7,opt,name=symbol_count_estimate,json=symbolCountEstimate,proto3" json:"symbol_count_estimate,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *SymbolBloomCandidate) Reset() {
	*x = SymbolBloomCandidate{}
	mi := &file_query_v1_query_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolBloomCandidate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolBloomCandidate) ProtoMessage() {}

func (x *SymbolBloomCandidate) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolBloomCandidate.ProtoReflect.Descriptor instead.
func (*SymbolBloomCandidate) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{18}
}

func (x *SymbolBloomCandidate) GetBlockId() string {
	if x != nil {
		return x.BlockId
	}
	return ""
...
func (x *SymbolBloomCandidate) GetDatasetIndex() uint32 {
	if x != nil {
...
func (x *SymbolBloomCandidate) GetServiceName() string {
	if x != nil {
...
func (x *SymbolBloomCandidate) GetSymbolNames() []string {
	if x != nil {
		return x.SymbolNames
	}
	return nil
...
func (x *SymbolBloomCandidate) GetMinTime() int64 {
	if x != nil {
		return x.MinTime
	}
	return 0
...
func (x *SymbolBloomCandidate) GetMaxTime() int64 {
	if x != nil {
		return x.MaxTime
	}
	return 0
...
func (x *SymbolBloomCandidate) GetSymbolCountEstimate() uint32 {
	if x != nil {
		return x.SymbolCountEstimate
	}
	return 0
}

type SymbolServicesReport struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Query         *SymbolServicesQuery    `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
	Results       []*SymbolServicesResult `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty"`
	Complete      bool                    `protobuf:"varint,3,opt,name=complete,proto3" json:"complete,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolServicesReport) Reset() {
	*x = SymbolServicesReport{}
	mi := &file_query_v1_query_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolServicesReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolServicesReport) ProtoMessage() {}

func (x *SymbolServicesReport) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolServicesReport.ProtoReflect.Descriptor instead.
func (*SymbolServicesReport) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{19}
}

func (x *SymbolServicesReport) GetQuery() *SymbolServicesQuery {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *SymbolServicesReport) GetResults() []*SymbolServicesResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *SymbolServicesReport) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
type SymbolServicesResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SymbolName    string                 `protobuf:"bytes,1,opt,name=symbol_name,json=symbolName,proto3" json:"symbol_name,omitempty"`
	Services      []*SymbolService       `protobuf:"bytes,2,rep,name=services,proto3" json:"services,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolServicesResult) Reset() {
	*x = SymbolServicesResult{}
	mi := &file_query_v1_query_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SymbolServicesResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolServicesResult) ProtoMessage() {}

func (x *SymbolServicesResult) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolServicesResult.ProtoReflect.Descriptor instead.
func (*SymbolServicesResult) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{20}
}

func (x *SymbolServicesResult) GetSymbolName() string {
	if x != nil {
		return x.SymbolName
	}
	return ""
...
func (x *SymbolServicesResult) GetServices() []*SymbolService {
	if x != nil {
		return x.Services
	}
	return nil
...
type SymbolService struct {
	...
	ProfileTypes  []string               `protobuf:"bytes,2,rep,name=profile_types,json=profileTypes,proto3" json:"profile_types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolService) Reset() {
	*x = SymbolService{}
...
func (x *SymbolService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolService) ProtoMessage() {}

func (x *SymbolService) ProtoReflect() protoreflect.Message {
	mi := &file_query_v1_query_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolService.ProtoReflect.Descriptor instead.
func (*SymbolService) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{21}
}

func (x *SymbolService) GetServiceName() string {
	if x != nil {
		return x.ServiceName
	}
	return ""
...
func (x *SymbolService) GetProfileTypes() []string {
	if x != nil {
...
type Point struct {
	...
	AnnotationRefs []int64 `protobuf:"varint,5,rep,packed,name=annotation_refs,json=annotationRefs,proto3" json:"annotation_refs,omitempty"`
...
func (x *Point) GetAnnotationRefs() []int64 {
	if x != nil {
		return x.AnnotationRefs
	}
	return nil
}
...
func (x *Series) Reset() {
	*x = Series{}
	mi := &file_query_v1_query_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Series) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{42}
}
...
type TimeSeriesCompactReport struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Query          *TimeSeriesQuery       `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
	TimeSeries     []*Series              `protobuf:"bytes,2,rep,name=time_series,json=timeSeries,proto3" json:"time_series,omitempty"`
	AttributeTable *AttributeTable        `protobuf:"bytes,3,opt,name=attribute_table,json=attributeTable,proto3" json:"attribute_table,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *TimeSeriesCompactReport) Reset() {
	*x = TimeSeriesCompactReport{}
	mi := &file_query_v1_query_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TimeSeriesCompactReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*TimeSeriesCompactReport) Descriptor() ([]byte, []int) {
	return file_query_v1_query_proto_rawDescGZIP(), []int{43}
}
...
func (x *TimeSeriesCompactReport) GetTimeSeries() []*Series {
	if x != nil {
		return x.TimeSeries
	}
	return nil
...
func (x *TimeSeriesCompactReport) GetAttributeTable() *AttributeTable {
	if x != nil {
		return x.AttributeTable
	}
	return nil
...
const file_query_v1_query_proto_rawDesc = "" +
	...
	"\rQueryResponse\x12*\n" +
	"\areports\x18\x01 \x03(\v2\x10.query.v1.ReportR\areports\"\x9b\x01\n" +
	"\x15SymbolServicesRequest\x12\x1d\n" +
	"\n" +
	"start_time\x18\x01 \x01(\x03R\tstartTime\x12\x19\n" +
	"\bend_time\x18\x02 \x01(\x03R\aendTime\x12%\n" +
	"\x0elabel_selector\x18\x03 \x01(\tR\rlabelSelector\x12!\n" +
	"\fsymbol_names\x18\x04 \x03(\tR\vsymbolNames\"n\n" +
	"\x16SymbolServicesResponse\x128\n" +
	"\aresults\x18\x01 \x03(\v2\x1e.query.v1.SymbolServicesResultR\aresults\x12\x1a\n" +
	"\bcomplete\x18\x02 \x01(\bR\bcomplete\"l\n" +
	"\rInvokeOptions\x12*\n" +
	...
	"\x13time_series_compact\x18\t \x01(\v2\x19.query.v1.TimeSeriesQueryR\x11timeSeriesCompact\x12F\n" +
	"\x0fsymbol_services\x18\n" +
	" \x01(\v2\x1d.query.v1.SymbolServicesQueryR\x0esymbolServices\x12\\\n" +
	"\x17symbol_bloom_candidates\x18\v \x01(\v2$.query.v1.SymbolBloomCandidatesQueryR\x15symbolBloomCandidates\"u\n" +
	...
	"\x10compaction_level\x18\a \x01(\rR\x0fcompactionLevel\"\xc1\x05\n" +
	"\x06Report\x125\n" +
	...
	"\x13time_series_compact\x18\t \x01(\v2!.query.v1.TimeSeriesCompactReportR\x11timeSeriesCompact\x12G\n" +
	"\x0fsymbol_services\x18\n" +
	" \x01(\v2\x1e.query.v1.SymbolServicesReportR\x0esymbolServices\x12]\n" +
	"\x17symbol_bloom_candidates\x18\v \x01(\v2%.query.v1.SymbolBloomCandidatesReportR\x15symbolBloomCandidates\"x\n" +
	"\x13SymbolServicesQuery\x12!\n" +
	"\fsymbol_names\x18\x01 \x03(\tR\vsymbolNames\x12>\n" +
	"\n" +
	"candidates\x18\x02 \x03(\v2\x1e.query.v1.SymbolBloomCandidateR\n" +
	"candidates\"?\n" +
	"\x1aSymbolBloomCandidatesQuery\x12!\n" +
	"\fsymbol_names\x18\x01 \x03(\tR\vsymbolNames\"\xb5\x01\n" +
	"\x1bSymbolBloomCandidatesReport\x12:\n" +
	"\x05query\x18\x01 \x01(\v2$.query.v1.SymbolBloomCandidatesQueryR\x05query\x12>\n" +
	"\n" +
	"candidates\x18\x02 \x03(\v2\x1e.query.v1.SymbolBloomCandidateR\n" +
	"candidates\x12\x1a\n" +
	"\bcomplete\x18\x03 \x01(\bR\bcomplete\"\x86\x02\n" +
	"\x14SymbolBloomCandidate\x12\x19\n" +
	"\bblock_id\x18\x01 \x01(\tR\ablockId\x12#\n" +
	"\rdataset_index\x18\x02 \x01(\rR\fdatasetIndex\x12!\n" +
	"\fservice_name\x18\x03 \x01(\tR\vserviceName\x12!\n" +
	"\fsymbol_names\x18\x04 \x03(\tR\vsymbolNames\x12\x19\n" +
	"\bmin_time\x18\x05 \x01(\x03R\aminTime\x12\x19\n" +
	"\bmax_time\x18\x06 \x01(\x03R\amaxTime\x122\n" +
	"\x15symbol_count_estimate\x18\a \x01(\rR\x13symbolCountEstimate\"\xa1\x01\n" +
	"\x14SymbolServicesReport\x123\n" +
	"\x05query\x18\x01 \x01(\v2\x1d.query.v1.SymbolServicesQueryR\x05query\x128\n" +
	"\aresults\x18\x02 \x03(\v2\x1e.query.v1.SymbolServicesResultR\aresults\x12\x1a\n" +
	"\bcomplete\x18\x03 \x01(\bR\bcomplete\"l\n" +
	"\x14SymbolServicesResult\x12\x1f\n" +
	"\vsymbol_name\x18\x01 \x01(\tR\n" +
	"symbolName\x123\n" +
	"\bservices\x18\x02 \x03(\v2\x17.query.v1.SymbolServiceR\bservices\"W\n" +
	"\rSymbolService\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12#\n" +
	"\rprofile_types\x18\x02 \x03(\tR\fprofileTypes\"\x11\n" +
	...
	"timeSeries\x12A\n" +
	"\x0fattribute_table\x18\x03 \x01(\v2\x18.query.v1.AttributeTableR\x0eattributeTable*\x92\x02\n" +
	"\tQueryType\x12\x15\n" +
	...
	"\x19QUERY_TIME_SERIES_COMPACT\x10\b\x12\x19\n" +
	"\x15QUERY_SYMBOL_SERVICES\x10\t\x12!\n" +
	"\x1dQUERY_SYMBOL_BLOOM_CANDIDATES\x10\n" +
	"*\x9e\x02\n" +
	"\n" +
	"ReportType\x12\x16\n" +
	...
	"\x1aREPORT_TIME_SERIES_COMPACT\x10\b\x12\x1a\n" +
	"\x16REPORT_SYMBOL_SERVICES\x10\t\x12\"\n" +
	"\x1eREPORT_SYMBOL_BLOOM_CANDIDATES\x10\n" +
	"2R\n" +
...
var file_query_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_query_v1_query_proto_goTypes = []any{
	...
	(*SymbolServicesRequest)(nil),       // 5: query.v1.SymbolServicesRequest
	(*SymbolServicesResponse)(nil),      // 6: query.v1.SymbolServicesResponse
	(*InvokeOptions)(nil),               // 7: query.v1.InvokeOptions
	(*InvokeRequest)(nil),               // 8: query.v1.InvokeRequest
	(*QueryPlan)(nil),                   // 9: query.v1.QueryPlan
	(*QueryNode)(nil),                   // 10: query.v1.QueryNode
	(*Query)(nil),                       // 11: query.v1.Query
	(*InvokeResponse)(nil),              // 12: query.v1.InvokeResponse
	...
	(*SymbolServicesQuery)(nil),         // 18: query.v1.SymbolServicesQuery
	(*SymbolBloomCandidatesQuery)(nil),  // 19: query.v1.SymbolBloomCandidatesQuery
	(*SymbolBloomCandidatesReport)(nil), // 20: query.v1.SymbolBloomCandidatesReport
	(*SymbolBloomCandidate)(nil),        // 21: query.v1.SymbolBloomCandidate
	(*SymbolServicesReport)(nil),        // 22: query.v1.SymbolServicesReport
	(*SymbolServicesResult)(nil),        // 23: query.v1.SymbolServicesResult
	(*SymbolService)(nil),               // 24: query.v1.SymbolService
	(*LabelNamesQuery)(nil),             // 25: query.v1.LabelNamesQuery
	(*LabelNamesReport)(nil),            // 26: query.v1.LabelNamesReport
	(*LabelValuesQuery)(nil),            // 27: query.v1.LabelValuesQuery
	(*LabelValuesReport)(nil),           // 28: query.v1.LabelValuesReport
	(*SeriesLabelsQuery)(nil),           // 29: query.v1.SeriesLabelsQuery
	(*SeriesLabelsReport)(nil),          // 30: query.v1.SeriesLabelsReport
	(*TimeSeriesQuery)(nil),             // 31: query.v1.TimeSeriesQuery
	(*TimeSeriesReport)(nil),            // 32: query.v1.TimeSeriesReport
	(*TreeQuery)(nil),                   // 33: query.v1.TreeQuery
	(*TreeSymbols)(nil),                 // 34: query.v1.TreeSymbols
	(*TreeReport)(nil),                  // 35: query.v1.TreeReport
	(*PprofQuery)(nil),                  // 36: query.v1.PprofQuery
	(*PprofReport)(nil),                 // 37: query.v1.PprofReport
	(*HeatmapQuery)(nil),                // 38: query.v1.HeatmapQuery
	(*AttributeTable)(nil),              // 39: query.v1.AttributeTable
	(*HeatmapPoint)(nil),                // 40: query.v1.HeatmapPoint
	(*HeatmapSeries)(nil),               // 41: query.v1.HeatmapSeries
	(*HeatmapReport)(nil),               // 42: query.v1.HeatmapReport
	(*Exemplar)(nil),                    // 43: query.v1.Exemplar
	(*Point)(nil),                       // 44: query.v1.Point
	(*Series)(nil),                      // 45: query.v1.Series
	(*TimeSeriesCompactReport)(nil),     // 46: query.v1.TimeSeriesCompactReport
	(*v1.BlockMeta)(nil),                // 47: metastore.v1.BlockMeta
	(*v11.Labels)(nil),                  // 48: types.v1.Labels
	(v11.ExemplarType)(0),               // 49: types.v1.ExemplarType
	(*v11.Series)(nil),                  // 50: types.v1.Series
	(*v11.StackTraceSelector)(nil),      // 51: types.v1.StackTraceSelector
	(*v12.Mapping)(nil),                 // 52: google.v1.Mapping
	(*v12.Location)(nil),                // 53: google.v1.Location
	(*v12.Function)(nil),                // 54: google.v1.Function
	(v13.HeatmapQueryType)(0),           // 55: querier.v1.HeatmapQueryType
}
var file_query_v1_query_proto_depIdxs = []int32{
	11, // 0: query.v1.QueryRequest.query:type_name -> query.v1.Query
	17, // 1: query.v1.QueryResponse.reports:type_name -> query.v1.Report
	23, // 2: query.v1.SymbolServicesResponse.results:type_name -> query.v1.SymbolServicesResult
	11, // 3: query.v1.InvokeRequest.query:type_name -> query.v1.Query
	9,  // 4: query.v1.InvokeRequest.query_plan:type_name -> query.v1.QueryPlan
	7,  // 5: query.v1.InvokeRequest.options:type_name -> query.v1.InvokeOptions
	10, // 6: query.v1.QueryPlan.root:type_name -> query.v1.QueryNode
	2,  // 7: query.v1.QueryNode.type:type_name -> query.v1.QueryNode.Type
	10, // 8: query.v1.QueryNode.children:type_name -> query.v1.QueryNode
	47, // 9: query.v1.QueryNode.blocks:type_name -> metastore.v1.BlockMeta
	0,  // 10: query.v1.Query.query_type:type_name -> query.v1.QueryType
	25, // 11: query.v1.Query.label_names:type_name -> query.v1.LabelNamesQuery
	27, // 12: query.v1.Query.label_values:type_name -> query.v1.LabelValuesQuery
	29, // 13: query.v1.Query.series_labels:type_name -> query.v1.SeriesLabelsQuery
	31, // 14: query.v1.Query.time_series:type_name -> query.v1.TimeSeriesQuery
	33, // 15: query.v1.Query.tree:type_name -> query.v1.TreeQuery
	36, // 16: query.v1.Query.pprof:type_name -> query.v1.PprofQuery
	38, // 17: query.v1.Query.heatmap:type_name -> query.v1.HeatmapQuery
	31, // 18: query.v1.Query.time_series_compact:type_name -> query.v1.TimeSeriesQuery
	18, // 19: query.v1.Query.symbol_services:type_name -> query.v1.SymbolServicesQuery
	19, // 20: query.v1.Query.symbol_bloom_candidates:type_name -> query.v1.SymbolBloomCandidatesQuery
	17, // 21: query.v1.InvokeResponse.reports:type_name -> query.v1.Report
	13, // 22: query.v1.InvokeResponse.diagnostics:type_name -> query.v1.Diagnostics
	9,  // 23: query.v1.Diagnostics.query_plan:type_name -> query.v1.QueryPlan
	14, // 24: query.v1.Diagnostics.execution_node:type_name -> query.v1.ExecutionNode
	2,  // 25: query.v1.ExecutionNode.type:type_name -> query.v1.QueryNode.Type
	14, // 26: query.v1.ExecutionNode.children:type_name -> query.v1.ExecutionNode
	15, // 27: query.v1.ExecutionNode.stats:type_name -> query.v1.ExecutionStats
	16, // 28: query.v1.ExecutionStats.block_executions:type_name -> query.v1.BlockExecution
	1,  // 29: query.v1.Report.report_type:type_name -> query.v1.ReportType
	26, // 30: query.v1.Report.label_names:type_name -> query.v1.LabelNamesReport
	28, // 31: query.v1.Report.label_values:type_name -> query.v1.LabelValuesReport
	30, // 32: query.v1.Report.series_labels:type_name -> query.v1.SeriesLabelsReport
	32, // 33: query.v1.Report.time_series:type_name -> query.v1.TimeSeriesReport
	35, // 34: query.v1.Report.tree:type_name -> query.v1.TreeReport
	37, // 35: query.v1.Report.pprof:type_name -> query.v1.PprofReport
	42, // 36: query.v1.Report.heatmap:type_name -> query.v1.HeatmapReport
	46, // 37: query.v1.Report.time_series_compact:type_name -> query.v1.TimeSeriesCompactReport
	22, // 38: query.v1.Report.symbol_services:type_name -> query.v1.SymbolServicesReport
	20, // 39: query.v1.Report.symbol_bloom_candidates:type_name -> query.v1.SymbolBloomCandidatesReport
	21, // 40: query.v1.SymbolServicesQuery.candidates:type_name -> query.v1.SymbolBloomCandidate
	19, // 41: query.v1.SymbolBloomCandidatesReport.query:type_name -> query.v1.SymbolBloomCandidatesQuery
	21, // 42: query.v1.SymbolBloomCandidatesReport.candidates:type_name -> query.v1.SymbolBloomCandidate
	18, // 43: query.v1.SymbolServicesReport.query:type_name -> query.v1.SymbolServicesQuery
	23, // 44: query.v1.SymbolServicesReport.results:type_name -> query.v1.SymbolServicesResult
	24, // 45: query.v1.SymbolServicesResult.services:type_name -> query.v1.SymbolService
	25, // 46: query.v1.LabelNamesReport.query:type_name -> query.v1.LabelNamesQuery
	27, // 47: query.v1.LabelValuesReport.query:type_name -> query.v1.LabelValuesQuery
	29, // 48: query.v1.SeriesLabelsReport.query:type_name -> query.v1.SeriesLabelsQuery
	48, // 49: query.v1.SeriesLabelsReport.series_labels:type_name -> types.v1.Labels
	49, // 50: query.v1.TimeSeriesQuery.exemplar_type:type_name -> types.v1.ExemplarType
	31, // 51: query.v1.TimeSeriesReport.query:type_name -> query.v1.TimeSeriesQuery
	50, // 52: query.v1.TimeSeriesReport.time_series:type_name -> types.v1.Series
	51, // 53: query.v1.TreeQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	52, // 54: query.v1.TreeSymbols.mappings:type_name -> google.v1.Mapping
	53, // 55: query.v1.TreeSymbols.locations:type_name -> google.v1.Location
	54, // 56: query.v1.TreeSymbols.functions:type_name -> google.v1.Function
	33, // 57: query.v1.TreeReport.query:type_name -> query.v1.TreeQuery
	34, // 58: query.v1.TreeReport.symbols:type_name -> query.v1.TreeSymbols
	51, // 59: query.v1.PprofQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	36, // 60: query.v1.PprofReport.query:type_name -> query.v1.PprofQuery
	55, // 61: query.v1.HeatmapQuery.query_type:type_name -> querier.v1.HeatmapQueryType
	49, // 62: query.v1.HeatmapQuery.exemplar_type:type_name -> types.v1.ExemplarType
	40, // 63: query.v1.HeatmapSeries.points:type_name -> query.v1.HeatmapPoint
	38, // 64: query.v1.HeatmapReport.query:type_name -> query.v1.HeatmapQuery
	41, // 65: query.v1.HeatmapReport.heatmap_series:type_name -> query.v1.HeatmapSeries
	39, // 66: query.v1.HeatmapReport.attribute_table:type_name -> query.v1.AttributeTable
	43, // 67: query.v1.Point.exemplars:type_name -> query.v1.Exemplar
	44, // 68: query.v1.Series.points:type_name -> query.v1.Point
	31, // 69: query.v1.TimeSeriesCompactReport.query:type_name -> query.v1.TimeSeriesQuery
	45, // 70: query.v1.TimeSeriesCompactReport.time_series:type_name -> query.v1.Series
	39, // 71: query.v1.TimeSeriesCompactReport.attribute_table:type_name -> query.v1.AttributeTable
	3,  // 72: query.v1.QueryFrontendService.Query:input_type -> query.v1.QueryRequest
	8,  // 73: query.v1.QueryBackendService.Invoke:input_type -> query.v1.InvokeRequest
	4,  // 74: query.v1.QueryFrontendService.Query:output_type -> query.v1.QueryResponse
	12, // 75: query.v1.QueryBackendService.Invoke:output_type -> query.v1.InvokeResponse
...
func file_query_v1_query_proto_init() {
	...
	file_query_v1_query_proto_msgTypes[32].OneofWrappers = []any{}
	file_query_v1_query_proto_msgTypes[33].OneofWrappers = []any{}
	type x struct{}
