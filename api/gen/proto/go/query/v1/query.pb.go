...
const (
	...
	QueryType_QUERY_FUNCTION_TREE       QueryType = 10
)
...
const (
	...
	ReportType_REPORT_FUNCTION_TREE       ReportType = 10
)
...
type Query struct {
	...
	FunctionTree      *FunctionTreeQuery `protobuf:"bytes,11,opt,name=function_tree,json=functionTree,proto3" json:"function_tree,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type Report struct {
	...
	FunctionTree      *FunctionTreeReport      `protobuf:"bytes,11,opt,name=function_tree,json=functionTree,proto3" json:"function_tree,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_query_v1_query_proto_rawDesc = "" +
	...
	"\tfunctions\x18\n" +
	" \x01(\v2\x18.query.v1.FunctionsQueryR\tfunctions\x12@\n" +
	"\rfunction_tree\x18\v \x01(\v2\x1b.query.v1.FunctionTreeQueryR\ffunctionTree\"u\n" +
	...
	"\x10compaction_level\x18\a \x01(\rR\x0fcompactionLevel\"\x95\x05\n" +
	"\x06Report\x125\n" +
	...
	"\tfunctions\x18\n" +
	" \x01(\v2\x19.query.v1.FunctionsReportR\tfunctions\x12A\n" +
	"\rfunction_tree\x18\v \x01(\v2\x1c.query.v1.FunctionTreeReportR\ffunctionTree\"\x11\n" +
	...
	"\x04tree\x18\x02 \x01(\v2\x16.types.v1.FunctionTreeR\x04tree*\x82\x02\n" +
	"\tQueryType\x12\x15\n" +
	...
	"\x0fQUERY_FUNCTIONS\x10\t\x12\x17\n" +
	"\x13QUERY_FUNCTION_TREE\x10\n" +
	"*\x8e\x02\n" +
	"\n" +
	"ReportType\x12\x16\n" +
	...
	"\x10REPORT_FUNCTIONS\x10\t\x12\x18\n" +
	"\x14REPORT_FUNCTION_TREE\x10\n" +
	"2R\n" +
...
var file_query_v1_query_proto_goTypes = []any{
	...
	(*FunctionsQuery)(nil),          // 38: query.v1.FunctionsQuery
	(*FunctionTreeQuery)(nil),       // 39: query.v1.FunctionTreeQuery
	(*FunctionsReport)(nil),         // 40: query.v1.FunctionsReport
	(*FunctionTreeReport)(nil),      // 41: query.v1.FunctionTreeReport
	...
	(*v11.FunctionTreeOptions)(nil), // 51: types.v1.FunctionTreeOptions
	(*v11.FunctionTable)(nil),       // 52: types.v1.FunctionTable
	(*v11.FunctionTree)(nil),        // 53: types.v1.FunctionTree
}
var file_query_v1_query_proto_depIdxs = []int32{
	...
	38, // 18: query.v1.Query.functions:type_name -> query.v1.FunctionsQuery
	39, // 19: query.v1.Query.function_tree:type_name -> query.v1.FunctionTreeQuery
	...
	40, // 37: query.v1.Report.functions:type_name -> query.v1.FunctionsReport
	41, // 38: query.v1.Report.function_tree:type_name -> query.v1.FunctionTreeReport
	...
	43, // 42: query.v1.SeriesLabelsReport.series_labels:type_name -> types.v1.Labels
	44, // 43: query.v1.TimeSeriesQuery.exemplar_type:type_name -> types.v1.ExemplarType
	22, // 44: query.v1.TimeSeriesReport.query:type_name -> query.v1.TimeSeriesQuery
	45, // 45: query.v1.TimeSeriesReport.time_series:type_name -> types.v1.Series
	46, // 46: query.v1.TreeQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	...
	46, // 52: query.v1.PprofQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	27, // 53: query.v1.PprofReport.query:type_name -> query.v1.PprofQuery
	50, // 54: query.v1.HeatmapQuery.query_type:type_name -> querier.v1.HeatmapQueryType
	44, // 55: query.v1.HeatmapQuery.exemplar_type:type_name -> types.v1.ExemplarType
	31, // 56: query.v1.HeatmapSeries.points:type_name -> query.v1.HeatmapPoint
	29, // 57: query.v1.HeatmapReport.query:type_name -> query.v1.HeatmapQuery
	32, // 58: query.v1.HeatmapReport.heatmap_series:type_name -> query.v1.HeatmapSeries
	30, // 59: query.v1.HeatmapReport.attribute_table:type_name -> query.v1.AttributeTable
	34, // 60: query.v1.Point.exemplars:type_name -> query.v1.Exemplar
	35, // 61: query.v1.Series.points:type_name -> query.v1.Point
	22, // 62: query.v1.TimeSeriesCompactReport.query:type_name -> query.v1.TimeSeriesQuery
	36, // 63: query.v1.TimeSeriesCompactReport.time_series:type_name -> query.v1.Series
	30, // 64: query.v1.TimeSeriesCompactReport.attribute_table:type_name -> query.v1.AttributeTable
	46, // 65: query.v1.FunctionsQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	46, // 66: query.v1.FunctionTreeQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	51, // 67: query.v1.FunctionTreeQuery.options:type_name -> types.v1.FunctionTreeOptions
	38, // 68: query.v1.FunctionsReport.query:type_name -> query.v1.FunctionsQuery
	52, // 69: query.v1.FunctionsReport.table:type_name -> types.v1.FunctionTable
	39, // 70: query.v1.FunctionTreeReport.query:type_name -> query.v1.FunctionTreeQuery
	53, // 71: query.v1.FunctionTreeReport.tree:type_name -> types.v1.FunctionTree
...
func file_query_v1_query_proto_init() {
	...
	file_query_v1_query_proto_msgTypes[36].OneofWrappers = []any{}
	type x struct{}
