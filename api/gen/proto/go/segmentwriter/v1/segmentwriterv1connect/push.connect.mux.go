...
// RegisterSegmentWriterServiceHandler register an HTTP handler to a mux.Router from the service
// implementation.
func RegisterSegmentWriterServiceHandler(mux *mux.Router, svc SegmentWriterServiceHandler, opts ...connect.HandlerOption) {
	mux.Handle("/segmentwriter.v1.SegmentWriterService/Push", connect.NewUnaryHandler(
