...
func NewVersionClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) VersionClient {
...
func (c *versionClient) Version(ctx context.Context, req *connect_go.Request[v1.VersionRequest]) (*connect_go.Response[v1.VersionResponse], error) {
...
func NewVersionHandler(svc VersionHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	versionVersionHandler := connect_go.NewUnaryHandler(
...
func (UnimplementedVersionHandler) Version(context.Context, *connect_go.Request[v1.VersionRequest]) (*connect_go.Response[v1.VersionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("version.v1.Version.Version is not implemented"))
}
