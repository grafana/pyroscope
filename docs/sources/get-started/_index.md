...
1. In a browser, go to [Profiles Drilldown](/docs/grafana/<GRAFANA_VERSION>/explore/simplified-exploration/profiles/) in your Grafana instance at [https://localhost:3000/a/grafana-pyroscope-app/explore](https://localhost:3000/a/grafana-pyroscope-app/explore). This will let you use an intuitive interface for exploring your profile data.
