...
### Enhancements
* **profilecli**: Add [`query top`](../view-and-analyze-profile-data/profile-cli/) command for top label-value analysis ([#4889](https://github.com/grafana/pyroscope/pull/4889))
