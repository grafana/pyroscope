...
## Version 1.17.4 release notes

Maintenance release to address a security issue.

### Changes

* chore: bump react router (#4845)

## Version 1.17.3 release notes

Maintenance release to update Go version and address security vulnerability.

### Changes

* Update golang version to 1.24.13 ([#4830](https://github.com/grafana/pyroscope/pull/4830))

## Version 1.17.2 release notes

Maintenance release to update Go version and address security vulnerability.

### Changes

* Update Go to 1.24.12 to fix CVE-2025-61731 and CVE-2025-61726 ([#4802](https://github.com/grafana/pyroscope/pull/4802))

## Version 1.17.1 release notes

Maintenance release to revert unintended backward incompatible change.

### Changes

* Fix: Re-enable defaults for /render `from` and `until` parameters ([#4745](https://github.com/grafana/pyroscope/pull/4745))
