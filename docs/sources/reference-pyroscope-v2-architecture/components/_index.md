...
Most components are stateless and do not require any data persisted between process restarts. The [metastore](metastore/) is the only stateful component in the architecture, using Raft consensus for replication and fault tolerance.
