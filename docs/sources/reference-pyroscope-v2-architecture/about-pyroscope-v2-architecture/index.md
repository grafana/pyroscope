...
![Architecture diagram showing the Pyroscope v2 components and data flow between distributor, segment-writer, metastore, compaction-worker, query-frontend, query-backend, and object storage.](architecture-overview.svg)
