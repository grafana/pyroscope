...
- Grafana agent documnetation for [pyroscope.ebpf](https://grafana.com/docs/agent/next/flow/reference/components/pyroscope.ebpf/), [pyroscope.write](https://grafana.com/docs/agent/next/flow/reference/components/pyroscope.write/), [discovery.kubernetes](https://grafana.com/docs/agent/next/flow/reference/components/discovery.kubernetes/), [discovery.relabel](https://grafana.com/docs/agent/next/flow/reference/components/discovery.relabel/) components
