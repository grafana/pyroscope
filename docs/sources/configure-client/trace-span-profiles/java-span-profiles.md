...
ADD https://github.com/grafana/otel-profiling-java/releases/download/v2.1.1/pyroscope-otel-javaagent-extension.jar pyroscope-otel-javaagent-extension.jar
