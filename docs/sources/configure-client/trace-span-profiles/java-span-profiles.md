...
ADD https://github.com/grafana/otel-profiling-java/releases/download/v2.1.3/pyroscope-otel-javaagent-extension.jar pyroscope-otel-javaagent-extension.jar
