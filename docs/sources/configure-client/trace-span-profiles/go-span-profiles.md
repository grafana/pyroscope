...
To learn how to set up Traces to profiles and view the span profiles, refer to [Traces to profiles](../../../view-and-analyze-profile-data/profile-tracing/traces-to-profiles/).
