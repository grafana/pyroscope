...
For more information, refer to [configure object storage](../../configure-server/configure-object-storage-backend/) and [configure disk storage](../../configure-server/configure-disk-storage/).
