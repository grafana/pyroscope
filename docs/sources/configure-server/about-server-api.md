...
For an example Python script to ingest a pprof file with a custom sample type configuration, see **[this Python script](https://github.com/grafana/pyroscope/tree/release/v1.3/examples/api/ingest_pprof.py).**
...
See [this Python script](https://github.com/grafana/pyroscope/tree/release/v1.3/examples/api/query.py) for a complete example.
