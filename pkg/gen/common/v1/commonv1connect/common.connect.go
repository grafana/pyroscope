...
const (
	...
	StatusServiceName = "common.v1.StatusService"
)

// StatusServiceClient is a client for the common.v1.StatusService service.
...
func NewStatusServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) StatusServiceClient {
	...
	return &statusServiceClient{
		getBuildInfo: connect_go.NewClient[v1.GetBuildInfoRequest, v1.GetBuildInfoResponse](
			httpClient,
			baseURL+"/common.v1.StatusService/GetBuildInfo",
			opts...,
		),
...
// GetConfig calls common.v1.StatusService.GetConfig.
...
func NewStatusServiceHandler(svc StatusServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/common.v1.StatusService/GetBuildInfo", connect_go.NewUnaryHandler(
		"/common.v1.StatusService/GetBuildInfo",
		svc.GetBuildInfo,
		opts...,
	))
	mux.Handle("/common.v1.StatusService/GetConfig", connect_go.NewUnaryHandler(
		"/common.v1.StatusService/GetConfig",
		svc.GetConfig,
		opts...,
	))
...
func (UnimplementedStatusServiceHandler) GetBuildInfo(context.Context, *connect_go.Request[v1.GetBuildInfoRequest]) (*connect_go.Response[v1.GetBuildInfoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("common.v1.StatusService.GetBuildInfo is not implemented"))
}
