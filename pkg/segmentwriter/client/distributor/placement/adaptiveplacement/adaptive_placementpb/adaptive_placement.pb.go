...
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc = string([]byte{
...
var (
	...
	file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDescData []byte
)
...
func file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDescGZIP() []byte {
	file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDescOnce.Do(func() {
		file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc), len(file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc)))
	})
...
func file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc), len(file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
