...
type Config struct {
	...
	QueryIndexLookup       bool             `yaml:"query_index_lookup" json:"query_index_lookup" category:"experimental" doc:"hidden"`
}
...
func (o *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&o.QueryIndexLookup, "querier.query-index-lookup-enabled", false,
		"Use the index lookup stage to resolve datasets before query execution. Experimental.")
}
