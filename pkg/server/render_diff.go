...
func (ctrl *Controller) renderDiffHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Which we don't care for Diff, since the timeline is generated by plotting left AND right
	...
	combined, err := flamebearer.NewCombinedProfile("diff", &noopOut, leftOut, rightOut, params.MaxNodes)
	if err != nil {
		ctrl.writeInvalidParameterError(w, err)
		return
	}
