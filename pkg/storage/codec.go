...
func (treeCodec) New() interface{} { return tree.New() }
...
func (c treeCodec) Deserialize(k string, r io.Reader) (interface{}, error) {
	key := segment.FromTreeToDictKey(k)
	d, err := c.dicts.GetOrCreate(key)
	if err != nil {
