...
package consul // revive:disable-line:import-shadowing package name is not referenced
...
import (
	...
	"github.com/grafana/pyroscope/pkg/og/scrape/model"
	"github.com/grafana/pyroscope/pkg/og/util/strutil"
...
func (d *Discovery) getDatacenter() error {
	...
	d.logger = logrus.WithField("datacenter", dc)
	return nil
}
