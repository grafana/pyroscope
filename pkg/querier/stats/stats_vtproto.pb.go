...
func (m *Stats) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.WallTime != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.WallTime))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Stats) SizeVT() (n int) {
	...
	_ = l
	if m.WallTime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.WallTime))
	}
	if m.FetchedSeriesCount != 0 {
	...
	if m.FetchedChunksCount != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FetchedChunksCount))
	}
	if m.ShardedQueries != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ShardedQueries))
	}
	if m.SplitQueries != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.SplitQueries))
	}
	if m.FetchedIndexBytes != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.FetchedIndexBytes))
	}
