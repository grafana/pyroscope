...
func (m *Stats) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.FetchedIndexBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.FetchedIndexBytes))
		i--
		dAtA[i] = 0x38
	}
	if m.SplitQueries != 0 {
		i = encodeVarint(dAtA, i, uint64(m.SplitQueries))
		i--
		dAtA[i] = 0x30
	}
	if m.ShardedQueries != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ShardedQueries))
		i--
		dAtA[i] = 0x28
	}
	if m.FetchedChunksCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.FetchedChunksCount))
		i--
		dAtA[i] = 0x20
	}
	if m.FetchedChunkBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.FetchedChunkBytes))
		i--
		dAtA[i] = 0x18
	}
	if m.FetchedSeriesCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.FetchedSeriesCount))
		i--
		dAtA[i] = 0x10
	}
	if m.WallTime != 0 {
		i = encodeVarint(dAtA, i, uint64(m.WallTime))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Stats) SizeVT() (n int) {
	...
	_ = l
	if m.WallTime != 0 {
		n += 1 + sov(uint64(m.WallTime))
	}
	if m.FetchedSeriesCount != 0 {
		n += 1 + sov(uint64(m.FetchedSeriesCount))
	}
	if m.FetchedChunkBytes != 0 {
		n += 1 + sov(uint64(m.FetchedChunkBytes))
	}
	if m.FetchedChunksCount != 0 {
		n += 1 + sov(uint64(m.FetchedChunksCount))
	}
	if m.ShardedQueries != 0 {
		n += 1 + sov(uint64(m.ShardedQueries))
	}
	if m.SplitQueries != 0 {
		n += 1 + sov(uint64(m.SplitQueries))
	}
	if m.FetchedIndexBytes != 0 {
		n += 1 + sov(uint64(m.FetchedIndexBytes))
	}
