...
import (
	...
	store2 "github.com/grafana/pyroscope/pkg/metastore/index/store"
)
...
func (_m *MockStore) DeleteShard(tx *bbolt.Tx, p store2.Partition, tenant string, shard uint32) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, store2.Partition, string, uint32) error); ok {
...
func (_c *MockStore_DeleteShard_Call) Run(run func(tx *bbolt.Tx, p store2.Partition, tenant string, shard uint32)) *MockStore_DeleteShard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bbolt.Tx), args[1].(store2.Partition), args[2].(string), args[3].(uint32))
	})
	return _c
}
...
func (_c *MockStore_DeleteShard_Call) RunAndReturn(run func(*bbolt.Tx, store2.Partition, string, uint32) error) *MockStore_DeleteShard_Call {
	_c.Call.Return(run)
	return _c
}

// LoadShard provides a mock function with given fields: tx, p, tenant, shard
func (_m *MockStore) LoadShard(tx *bbolt.Tx, p store2.Partition, tenant string, shard uint32) (*store2.Shard, error) {
	ret := _m.Called(tx, p, tenant, shard)
	...
	var r0 *store2.Shard
	var r1 error
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, store2.Partition, string, uint32) (*store2.Shard, error)); ok {
		return rf(tx, p, tenant, shard)
	}
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, store2.Partition, string, uint32) *store2.Shard); ok {
		r0 = rf(tx, p, tenant, shard)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*store2.Shard)
		}
	}

	if rf, ok := ret.Get(1).(func(*bbolt.Tx, store2.Partition, string, uint32) error); ok {
...
func (_c *MockStore_LoadShard_Call) Run(run func(tx *bbolt.Tx, p store2.Partition, tenant string, shard uint32)) *MockStore_LoadShard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bbolt.Tx), args[1].(store2.Partition), args[2].(string), args[3].(uint32))
	})
	return _c
...
func (_c *MockStore_LoadShard_Call) Return(_a0 *store2.Shard, _a1 error) *MockStore_LoadShard_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStore_LoadShard_Call) RunAndReturn(run func(*bbolt.Tx, store2.Partition, string, uint32) (*store2.Shard, error)) *MockStore_LoadShard_Call {
	_c.Call.Return(run)
	return _c
}

// Partitions provides a mock function with given fields: tx
func (_m *MockStore) Partitions(tx *bbolt.Tx) iter.Seq[store2.Partition] {
	ret := _m.Called(tx)
	...
	var r0 iter.Seq[store2.Partition]
	if rf, ok := ret.Get(0).(func(*bbolt.Tx) iter.Seq[store2.Partition]); ok {
		r0 = rf(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq[store2.Partition])
		}
	}
...
func (_c *MockStore_Partitions_Call) Return(_a0 iter.Seq[store2.Partition]) *MockStore_Partitions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStore_Partitions_Call) RunAndReturn(run func(*bbolt.Tx) iter.Seq[store2.Partition]) *MockStore_Partitions_Call {
	_c.Call.Return(run)
	return _c
}
