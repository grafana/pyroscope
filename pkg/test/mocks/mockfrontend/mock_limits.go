...
func (_m *MockLimits) QueryPprofFlatPlanEnabled(_a0 string) bool {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for QueryPprofFlatPlanEnabled")
	}
...
func (_m *MockLimits) QueryInternalPprofOutputMode(_a0 string) string {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for QueryInternalPprofOutputMode")
	}
