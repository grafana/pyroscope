...
import (
	...
	store "github.com/grafana/pyroscope/v2/pkg/metastore/compaction/scheduler/store"
)
...
// GetJobPlanSummary provides a mock function with given fields: tx, name, withSourceBlocks
func (_m *MockJobStore) GetJobPlanSummary(tx *bbolt.Tx, name string, withSourceBlocks bool) (*store.JobPlanSummary, error) {
	ret := _m.Called(tx, name, withSourceBlocks)

	if len(ret) == 0 {
		panic("no return value specified for GetJobPlanSummary")
	}

	var r0 *store.JobPlanSummary
	var r1 error
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, string, bool) (*store.JobPlanSummary, error)); ok {
		return rf(tx, name, withSourceBlocks)
	}
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, string, bool) *store.JobPlanSummary); ok {
		r0 = rf(tx, name, withSourceBlocks)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*store.JobPlanSummary)
		}
	}

	if rf, ok := ret.Get(1).(func(*bbolt.Tx, string, bool) error); ok {
		r1 = rf(tx, name, withSourceBlocks)
	} else {
		r1 = ret.Error(1)
	}
...
// MockJobStore_GetJobPlanSummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetJobPlanSummary'
type MockJobStore_GetJobPlanSummary_Call struct {
	*mock.Call
}

// GetJobPlanSummary is a helper method to define mock.On call
//   - tx *bbolt.Tx
//   - name string
//   - withSourceBlocks bool
func (_e *MockJobStore_Expecter) GetJobPlanSummary(tx interface{}, name interface{}, withSourceBlocks interface{}) *MockJobStore_GetJobPlanSummary_Call {
	return &MockJobStore_GetJobPlanSummary_Call{Call: _e.mock.On("GetJobPlanSummary", tx, name, withSourceBlocks)}
}

func (_c *MockJobStore_GetJobPlanSummary_Call) Run(run func(tx *bbolt.Tx, name string, withSourceBlocks bool)) *MockJobStore_GetJobPlanSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bbolt.Tx), args[1].(string), args[2].(bool))
	})
	return _c
}

func (_c *MockJobStore_GetJobPlanSummary_Call) Return(_a0 *store.JobPlanSummary, _a1 error) *MockJobStore_GetJobPlanSummary_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockJobStore_GetJobPlanSummary_Call) RunAndReturn(run func(*bbolt.Tx, string, bool) (*store.JobPlanSummary, error)) *MockJobStore_GetJobPlanSummary_Call {
	_c.Call.Return(run)
	return _c
}
