...
import (
	...
	pkgobjstore "github.com/grafana/pyroscope/v2/pkg/objstore"
)
...
// IsConditionNotMetErr provides a mock function with given fields: err
func (_m *MockBucket) IsConditionNotMetErr(err error) bool {
	ret := _m.Called(err)

	if len(ret) == 0 {
		panic("no return value specified for IsConditionNotMetErr")
	}
...
// MockBucket_IsConditionNotMetErr_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsConditionNotMetErr'
type MockBucket_IsConditionNotMetErr_Call struct {
	*mock.Call
}

// IsConditionNotMetErr is a helper method to define mock.On call
//   - err error
func (_e *MockBucket_Expecter) IsConditionNotMetErr(err interface{}) *MockBucket_IsConditionNotMetErr_Call {
	return &MockBucket_IsConditionNotMetErr_Call{Call: _e.mock.On("IsConditionNotMetErr", err)}
}

func (_c *MockBucket_IsConditionNotMetErr_Call) Run(run func(err error)) *MockBucket_IsConditionNotMetErr_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(error))
	})
	return _c
...
func (_c *MockBucket_IsConditionNotMetErr_Call) Return(_a0 bool) *MockBucket_IsConditionNotMetErr_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBucket_IsConditionNotMetErr_Call) RunAndReturn(run func(error) bool) *MockBucket_IsConditionNotMetErr_Call {
	_c.Call.Return(run)
	return _c
}
...
// SupportedObjectUploadOptions provides a mock function with no fields
func (_m *MockBucket) SupportedObjectUploadOptions() []objstore.ObjectUploadOptionType {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for SupportedObjectUploadOptions")
	}

	var r0 []objstore.ObjectUploadOptionType
	if rf, ok := ret.Get(0).(func() []objstore.ObjectUploadOptionType); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]objstore.ObjectUploadOptionType)
		}
	}
...
// MockBucket_SupportedObjectUploadOptions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SupportedObjectUploadOptions'
type MockBucket_SupportedObjectUploadOptions_Call struct {
	*mock.Call
}

// SupportedObjectUploadOptions is a helper method to define mock.On call
func (_e *MockBucket_Expecter) SupportedObjectUploadOptions() *MockBucket_SupportedObjectUploadOptions_Call {
	return &MockBucket_SupportedObjectUploadOptions_Call{Call: _e.mock.On("SupportedObjectUploadOptions")}
}

func (_c *MockBucket_SupportedObjectUploadOptions_Call) Run(run func()) *MockBucket_SupportedObjectUploadOptions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockBucket_SupportedObjectUploadOptions_Call) Return(_a0 []objstore.ObjectUploadOptionType) *MockBucket_SupportedObjectUploadOptions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBucket_SupportedObjectUploadOptions_Call) RunAndReturn(run func() []objstore.ObjectUploadOptionType) *MockBucket_SupportedObjectUploadOptions_Call {
	_c.Call.Return(run)
	return _c
}
