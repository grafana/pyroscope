...
func (_m *MockIngesterClient) Push(_a0 context.Context, _a1 *model.ProfileSeriesTransientRequest) (*connect.Response[pushv1.PushResponse], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.ProfileSeriesTransientRequest) (*connect.Response[pushv1.PushResponse], error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *model.ProfileSeriesTransientRequest) *connect.Response[pushv1.PushResponse]); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *model.ProfileSeriesTransientRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockIngesterClient_Push_Call) Run(run func(_a0 context.Context, _a1 *model.ProfileSeriesTransientRequest)) *MockIngesterClient_Push_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.ProfileSeriesTransientRequest))
	})
	return _c
}
...
func (_c *MockIngesterClient_Push_Call) RunAndReturn(run func(context.Context, *model.ProfileSeriesTransientRequest) (*connect.Response[pushv1.PushResponse], error)) *MockIngesterClient_Push_Call {
	_c.Call.Return(run)
	return _c
}
