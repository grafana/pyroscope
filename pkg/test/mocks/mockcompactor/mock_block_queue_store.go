...
func (_m *MockBlockQueueStore) ListEntries(_a0 *bbolt.Tx) iter.Iterator[store.BlockEntry] {
	ret := _m.Called(_a0)
...
func (_c *MockBlockQueueStore_ListEntries_Call) Return(_a0 iter.Iterator[store.BlockEntry]) *MockBlockQueueStore_ListEntries_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBlockQueueStore_ListEntries_Call) RunAndReturn(run func(*bbolt.Tx) iter.Iterator[store.BlockEntry]) *MockBlockQueueStore_ListEntries_Call {
	_c.Call.Return(run)
	return _c
}

// StoreEntry provides a mock function with given fields: _a0, _a1
func (_m *MockBlockQueueStore) StoreEntry(_a0 *bbolt.Tx, _a1 store.BlockEntry) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*bbolt.Tx, store.BlockEntry) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockBlockQueueStore_StoreEntry_Call) Run(run func(_a0 *bbolt.Tx, _a1 store.BlockEntry)) *MockBlockQueueStore_StoreEntry_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bbolt.Tx), args[1].(store.BlockEntry))
	})
	return _c
}
...
func (_c *MockBlockQueueStore_StoreEntry_Call) RunAndReturn(run func(*bbolt.Tx, store.BlockEntry) error) *MockBlockQueueStore_StoreEntry_Call {
	_c.Call.Return(run)
	return _c
}
