...
func TestSampleAttributes(t *testing.T) {
	...
	assert.Equal(t, 0, len(seriesLabelsMap))
	...
	require.Equal(t, " TODO chrome.so 0x2e;chrome.so 0x2e 61423", ss[0])
	require.Equal(t, "TODO firefox.so 0x2e;firefox.so 0x2e 239", ss[1])
}
