...
func TestLoader_GetIndex_ShouldLazyLoadBucketIndex(t *testing.T) {
	...
	assert.NoError(t, testutil.GatherAndCompare(reg, bytes.NewBufferString(`
		# HELP pyroscope_bucket_index_load_failures_total Total number of bucket index loading failures.
		# TYPE pyroscope_bucket_index_load_failures_total counter
		pyroscope_bucket_index_load_failures_total 0
		...
		# HELP pyroscope_bucket_index_loads_total Total number of bucket index loading attempts.
		# TYPE pyroscope_bucket_index_loads_total counter
		pyroscope_bucket_index_loads_total 0
	`),
		"pyroscope_bucket_index_loads_total",
		"pyroscope_bucket_index_load_failures_total",
	...
	assert.NoError(t, testutil.GatherAndCompare(reg, bytes.NewBufferString(`
		...
		# HELP pyroscope_bucket_index_loaded Number of bucket indexes currently loaded in-memory.
		# TYPE pyroscope_bucket_index_loaded gauge
		pyroscope_bucket_index_loaded 1
		# HELP pyroscope_bucket_index_loads_total Total number of bucket index loading attempts.
		# TYPE pyroscope_bucket_index_loads_total counter
		pyroscope_bucket_index_loads_total 1
	`),
		"pyroscope_bucket_index_loads_total",
		"pyroscope_bucket_index_load_failures_total",
		"pyroscope_bucket_index_loaded",
...
func TestLoader_GetIndex_ShouldCacheError(t *testing.T) {
	...
	assert.NoError(t, testutil.GatherAndCompare(reg, bytes.NewBufferString(`
		# HELP pyroscope_bucket_index_load_failures_total Total number of bucket index loading failures.
		# TYPE pyroscope_bucket_index_load_failures_total counter
		pyroscope_bucket_index_load_failures_total 1
		# HELP pyroscope_bucket_index_loaded Number of bucket indexes currently loaded in-memory.
		# TYPE pyroscope_bucket_index_loaded gauge
		pyroscope_bucket_index_loaded 0
		# HELP pyroscope_bucket_index_loads_total Total number of bucket index loading attempts.
...
func TestLoader_ShouldOffloadIndexIfIdleTimeoutIsReachedDuringBackgroundUpdates(t *testing.T) {
	...
	assert.NoError(t, testutil.GatherAndCompare(reg, bytes.NewBufferString(`
		# HELP pyroscope_bucket_index_loads_total Total number of bucket index loading attempts.
		# TYPE pyroscope_bucket_index_loads_total counter
		pyroscope_bucket_index_loads_total 2
	`),
		"pyroscope_bucket_index_loads_total",
	))
}
