...
func (b *singleBlockQuerier) MergePprof(ctx context.Context, rows iter.Iterator[Profile], maxNodes int64, fn *phlaremodel.FunctionSelector) (*profilev1.Profile, error) {
