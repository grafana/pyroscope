...
import (
	...
	phlareobjclient "github.com/grafana/pyroscope/v2/pkg/objstore/client"
...
func TestProfileStore_Querying(t *testing.T) {
	...
	t.Run("merge by stacktraces", func(t *testing.T) {
		...
		at, err := phlaremodel.UnmarshalTree[phlaremodel.FunctionName, phlaremodel.FunctionNameI](result.Result.TreeBytes)
		require.NoError(t, err)
