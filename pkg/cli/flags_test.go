		...
		Context("with config file", func() {
			...
			It("server configuration", func() {
				...
				Expect(cfg).To(Equal(config.Server{
					...
					BadgerValueLogSize:        1073741824,
					BadgerGCSizeDiff:          1073741824,
					BadgerGCDiscardRatio:      0.7,
					BadgerGCTaskInterval:      300000000000,
					MetricsUpdateTaskInterval: 10000000000,
					WriteBackTaskInterval:     60000000000,
					EvictionTaskInterval:      20000000000,
					RetentionTaskInterval:     600000000000,
