...
var file_experiment_metastore_compactionpb_compaction_proto_goTypes = []interface{}{
...
func file_experiment_metastore_compactionpb_compaction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_experiment_metastore_compactionpb_compaction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_experiment_metastore_compactionpb_compaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
