...
type PlacementLimits struct {
	...
	TenantShardLimit  uint64        `protobuf:"varint,1,opt,name=tenant_shard_limit,json=tenantShardLimit,proto3" json:"tenant_shard_limit,omitempty"`
	DatasetShardLimit uint64        `protobuf:"varint,2,opt,name=dataset_shard_limit,json=datasetShardLimit,proto3" json:"dataset_shard_limit,omitempty"`
...
func (x *PlacementLimits) GetTenantShardLimit() uint64 {
	if x != nil {
...
func (x *PlacementLimits) GetDatasetShardLimit() uint64 {
	if x != nil {
...
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x72, 0x64, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
