...
const (
	...
	LoadBalancing_LOAD_BALANCING_FINGERPRINT_MOD LoadBalancing = 1
...
var (
	LoadBalancing_name = map[int32]string{
		...
		1: "LOAD_BALANCING_FINGERPRINT_MOD",
...
type DatasetStats struct {
	...
	Shards []uint32 `protobuf:"varint,3,rep,packed,name=shards,proto3" json:"shards,omitempty"` // Shard value is a reference to ShardStats.
...
type PlacementLimits struct {
	...
	TenantShardLimit  uint32        `protobuf:"varint,1,opt,name=tenant_shard_limit,json=tenantShardLimit,proto3" json:"tenant_shard_limit,omitempty"`
	DatasetShardLimit uint32        `protobuf:"varint,2,opt,name=dataset_shard_limit,json=datasetShardLimit,proto3" json:"dataset_shard_limit,omitempty"`
	LoadBalancing     LoadBalancing `protobuf:"varint,3,opt,name=load_balancing,json=loadBalancing,proto3,enum=adaptive_placement.LoadBalancing" json:"load_balancing,omitempty"`
}

func (x *PlacementLimits) Reset() {
	*x = PlacementLimits{}
	if protoimpl.UnsafeEnabled {
...
func (x *PlacementLimits) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlacementLimits) ProtoMessage() {}

func (x *PlacementLimits) ProtoReflect() protoreflect.Message {
	mi := &file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlacementLimits.ProtoReflect.Descriptor instead.
func (*PlacementLimits) Descriptor() ([]byte, []int) {
...
func (x *PlacementLimits) GetTenantShardLimit() uint32 {
	if x != nil {
...
func (x *PlacementLimits) GetDatasetShardLimit() uint32 {
	if x != nil {
...
func (x *PlacementLimits) GetLoadBalancing() LoadBalancing {
	if x != nil {
...
type PlacementRules struct {
	...
	Defaults *PlacementLimits    `protobuf:"bytes,1,opt,name=defaults,proto3" json:"defaults,omitempty"`
	Tenants  []*TenantPlacement  `protobuf:"bytes,2,rep,name=tenants,proto3" json:"tenants,omitempty"`
	Datasets []*DatasetPlacement `protobuf:"bytes,3,rep,name=datasets,proto3" json:"datasets,omitempty"`
}
...
func (x *PlacementRules) GetDefaults() *PlacementLimits {
	if x != nil {
		return x.Defaults
	}
	return nil
...
type TenantPlacement struct {
	...
	// defined.
	Limits *PlacementLimits `protobuf:"bytes,2,opt,name=limits,proto3" json:"limits,omitempty"`
}
...
func (x *TenantPlacement) GetLimits() *PlacementLimits {
	if x != nil {
		return x.Limits
	}
	return nil
...
type DatasetPlacement struct {
	...
	Name          string        `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	ShardLimit    uint32        `protobuf:"varint,3,opt,name=shard_limit,json=shardLimit,proto3" json:"shard_limit,omitempty"`
	LoadBalancing LoadBalancing `protobuf:"varint,4,opt,name=load_balancing,json=loadBalancing,proto3,enum=adaptive_placement.LoadBalancing" json:"load_balancing,omitempty"`
}

func (x *DatasetPlacement) Reset() {
	*x = DatasetPlacement{}
	if protoimpl.UnsafeEnabled {
		mi := &file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DatasetPlacement) Descriptor() ([]byte, []int) {
	return file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDescGZIP(), []int{7}
}
...
func (x *DatasetPlacement) GetShardLimit() uint32 {
	if x != nil {
		return x.ShardLimit
	}
	return 0
...
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xc4, 0x01, 0x0a, 0x11, 0x44, 0x69, 0x73, 0x74,
	...
	0x64, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x06, 0x73, 0x68, 0x61, 0x72, 0x64, 0x73, 0x22, 0x2a,
	0x0a, 0x0b, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x1b, 0x0a,
	0x09, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x68, 0x0a, 0x0c, 0x44, 0x61,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x32, 0x0a, 0x0a, 0x53, 0x68, 0x61, 0x72, 0x64, 0x53, 0x74, 0x61,
	...
	,
	...
	,
}
...
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_goTypes = []any{
	...
	(*PlacementLimits)(nil),   // 5: adaptive_placement.PlacementLimits
	(*PlacementRules)(nil),    // 6: adaptive_placement.PlacementRules
	(*TenantPlacement)(nil),   // 7: adaptive_placement.TenantPlacement
	(*DatasetPlacement)(nil),  // 8: adaptive_placement.DatasetPlacement
}
var file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_depIdxs = []int32{
	...
	0, // 3: adaptive_placement.PlacementLimits.load_balancing:type_name -> adaptive_placement.LoadBalancing
	5, // 4: adaptive_placement.PlacementRules.defaults:type_name -> adaptive_placement.PlacementLimits
	7, // 5: adaptive_placement.PlacementRules.tenants:type_name -> adaptive_placement.TenantPlacement
	8, // 6: adaptive_placement.PlacementRules.datasets:type_name -> adaptive_placement.DatasetPlacement
	5, // 7: adaptive_placement.TenantPlacement.limits:type_name -> adaptive_placement.PlacementLimits
	0, // 8: adaptive_placement.DatasetPlacement.load_balancing:type_name -> adaptive_placement.LoadBalancing
...
func file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_experiment_distributor_placement_adaptive_placement_adaptive_placementpb_adaptive_placement_proto_msgTypes[7].Exporter = func(v any, i int) any {
