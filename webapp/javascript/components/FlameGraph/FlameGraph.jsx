...
//   }
//   const newRadius = Math.min(w / 2, radius);
//   const r = x + w;
//   const b = y + h;
//   ctx.beginPath();
//   ctx.moveTo(x + newRadius, y);
//   ctx.lineTo(r - newRadius, y);
//   ctx.quadraticCurveTo(r, y, r, y + newRadius);
//   ctx.lineTo(r, y + h - newRadius);
//   ctx.quadraticCurveTo(r, b, r - newRadius, b);
//   ctx.lineTo(x + newRadius, b);
//   ctx.quadraticCurveTo(x, b, x, b - newRadius);
//   ctx.lineTo(x, y + newRadius);
//   ctx.quadraticCurveTo(x, y, x + newRadius, y);
//   return ctx;
// };
    ...
    >
      ...
      <div
        className={clsx("no-data-message", {
          visible: this.props.flamebearer.numTicks === 0,
        })}
      >
        <span>
