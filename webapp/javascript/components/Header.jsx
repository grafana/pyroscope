...
class Header extends React.Component {
  ...
  render() {
    return <div className="navbar">
      ...
      <div>
        <span>Read our <a target="_blank" href="https://pyroscope.io/docs">documentation</a></span>
        &nbsp;
        &nbsp;
        |
        &nbsp;
      ...
      {/* <DownloadButton renderURL={this.props.renderURL+"&format=svg&download-filename=flamegraph.svg"} /> */}
      &nbsp;
      <RefreshButton/>
      {/* &nbsp; */}
      {/* <ZoomOutButton/> */}
