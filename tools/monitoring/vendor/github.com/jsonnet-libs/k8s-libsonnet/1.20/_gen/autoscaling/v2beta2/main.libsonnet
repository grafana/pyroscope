{
  ...
  containerResourceMetricSource: (import 'containerResourceMetricSource.libsonnet'),
  containerResourceMetricStatus: (import 'containerResourceMetricStatus.libsonnet'),
