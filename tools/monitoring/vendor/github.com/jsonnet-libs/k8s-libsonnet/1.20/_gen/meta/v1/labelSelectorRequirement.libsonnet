{
  ...
  '#':: d.pkg(name='labelSelectorRequirement', url='', help='"A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values."'),
