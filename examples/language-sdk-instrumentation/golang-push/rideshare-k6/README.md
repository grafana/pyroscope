...
- Grafana instance with the Profiles Drilldown app and a Pyroscope data source installed (http://localhost:3000)
...
Finally, navigate to http://localhost:3000 and open the Profiles Drilldown app. After a small delay, k6 test metadata should begin to appears as labels on the
