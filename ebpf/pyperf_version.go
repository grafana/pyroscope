...
var pyVersions = map[PythonVersion]userPyOffsetConfig{
	...
	PythonVersion{3, 5, 0}: {
		...
		PyThreadStateCframe:            -1,
		PyCFrameCurrentFrame:           -1,
	...
	PythonVersion{3, 11, 0}: {
		...
		PyThreadStateCframe:            56,
		PyCFrameCurrentFrame:           8,
