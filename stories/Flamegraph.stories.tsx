...
const SimpleTree = {
  ...
  flamebearer: {
    ...
    levels: [
      [0, 10 * 1e9, 0, 0], // samples in ns, => 10s
      [0, 6 * 1e9, 0, 13, 0, 3 * 1e8, 0, 1],
      [0, 6 * 1e9, 0, 14, 0, 3 * 1e8, 0, 2],
      [0, 6 * 1e9, 0, 15, 0, 3 * 1e8, 0, 3],
      [0, 6 * 1e9, 0, 16, 0, 1 * 1e8, 0, 10, 0, 2 * 1e8, 0, 4],
      [0, 6 * 1e9, 0, 17, 0, 1 * 1e8, 0, 11, 0, 1 * 1e8, 0, 5],
      [0, 6 * 1e9, 0, 18, 0, 1 * 1e8, 1, 12, 0, 1 * 1e8, 0, 6],
      [0, 5 * 1e9, 0, 23, 0, 1 * 1e9, 0, 19, 1, 1 * 1e8, 0, 7],
      [0, 5 * 1e9, 0, 15, 0, 1 * 1e9, 0, 16, 1, 1 * 1e8, 0, 8],
      [0, 4 * 1e9, 0, 16, 0, 1 * 1e9, 2048, 20, 1, 1 * 1e8, 2, 9],
      [0, 3 * 1e9, 0, 17, 0, 1 * 1e9, 2048, 21],
      [0, 2 * 1e9, 0, 24],
      [0, 1 * 1e9, 97, 21],
      [97, 4, 3, 22],
    ],
